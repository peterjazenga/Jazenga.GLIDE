...
begin
  //DebugLn('Hint: (GLIDE) [TLazSourceFileManager.PublishModule] START');
  Result:=mrCancel;
  ...
  //DebugLn('Hint: (GLIDE) [TLazSourceFileManager.PublishModule] SrcDir="',SrcDir,'" DestDir="',DestDir,'"');
  ...
  if (CmdAfterExe<>'') then begin
    //DebugLn('Hint: (GLIDE) [TLazSourceFileManager.PublishModule] CmdAfterExe="',CmdAfterExe,'"');
  ...
  begin
    debugln('Hint: (GLIDE) [TLazSourceFileManager.PublishModule] CopyDirectoryWithMethods failed');
    Result:=mrCancel;
    exit;
  end;
  ...
  if Options is TPublishProjectOptions then begin
    ...
    if Result<>mrOk then begin
      debugln('Hint: (GLIDE) [TLazSourceFileManager.PublishModule] CurProject.WriteProject failed');
      exit;
    end;
  end;

...
type
  ...
  TplGradGauge = class(TGraphicControl)
  private
    c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17, c18, c19, c20, backc: TColor;
    cco: TColorArray;
    ges, pro, max: integer;
    procedure Wbackc(Value: TColor);
    procedure Wprogress(Value: integer);
    procedure Wmaximum(Value: integer);
  ...
  published
    property BackColor: TColor read backc write wbackc;
    ...
    property Progress: integer read pro write wProgress;
    property Maximum: integer read max write wMaximum;
...
procedure TplGradGauge.Wbackc(Value: TColor);
begin
  backc := Value;
  malen;
end;

procedure TplGradGauge.WC1(Value: TColor);
begin
  c1 := Value;
  cco[1] := Value;
  malen;
...
procedure TplGradGauge.WC2(Value: TColor);
begin
  c2 := Value;
  cco[2] := Value;
  malen;
...
procedure TplGradGauge.WC3(Value: TColor);
begin
  c3 := Value;
  cco[3] := Value;
  malen;
...
procedure TplGradGauge.WC4(Value: TColor);
begin
  c4 := Value;
  cco[4] := Value;
  malen;
...
procedure TplGradGauge.WC5(Value: TColor);
begin
  c5 := Value;
  cco[5] := Value;
  malen;
...
procedure TplGradGauge.WC6(Value: TColor);
begin
  c6 := Value;
  cco[6] := Value;
  malen;
...
procedure TplGradGauge.WC7(Value: TColor);
begin
  c7 := Value;
  cco[7] := Value;
  malen;
...
procedure TplGradGauge.WC8(Value: TColor);
begin
  c8 := Value;
  cco[8] := Value;
  malen;
...
procedure TplGradGauge.WC9(Value: TColor);
begin
  c9 := Value;
  cco[9] := Value;
  malen;
...
procedure TplGradGauge.WC10(Value: TColor);
begin
  c10 := Value;
  cco[10] := Value;
  malen;
...
procedure TplGradGauge.WC11(Value: TColor);
begin
  c11 := Value;
  cco[11] := Value;
  malen;
...
procedure TplGradGauge.WC12(Value: TColor);
begin
  c12 := Value;
  cco[12] := Value;
  malen;
...
procedure TplGradGauge.WC13(Value: TColor);
begin
  c13 := Value;
  cco[13] := Value;
  malen;
...
procedure TplGradGauge.WC14(Value: TColor);
begin
  c14 := Value;
  cco[14] := Value;
  malen;
...
procedure TplGradGauge.WC15(Value: TColor);
begin
  c15 := Value;
  cco[15] := Value;
  malen;
...
procedure TplGradGauge.WC16(Value: TColor);
begin
  c16 := Value;
  cco[16] := Value;
  malen;
...
procedure TplGradGauge.WC17(Value: TColor);
begin
  c17 := Value;
  cco[17] := Value;
  malen;
...
procedure TplGradGauge.WC18(Value: TColor);
begin
  c18 := Value;
  cco[18] := Value;
  malen;
...
procedure TplGradGauge.WC19(Value: TColor);
begin
  c19 := Value;
  cco[19] := Value;
  malen;
...
procedure TplGradGauge.WC20(Value: TColor);
begin
  c20 := Value;
  cco[20] := Value;
  malen;
...
procedure TplGradGauge.WG1(Value: integer);
begin
  ges := Value;
  malen;
end;

procedure TplGradGauge.Wprogress(Value: integer);
begin
...
procedure TplGradGauge.Wmaximum(Value: integer);
begin
  max := Value;
  malen;
end;
...
constructor TplGradGauge.Create(aComponent: TComponent);
begin
...
procedure TplGradGauge.malen;
var
  c: TColorArray;
  a, bb, cc, maxx: integer;
...
begin
  ...
  tt := 0;
  c := cco;
  maxx := (pro * 100) div max;
  maxx := (maxx * Width) div 100;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Canvas.Rectangle(a, 0, Width + 1, Height + 1);
        exit;
      end;
      if r < r2 then
        r := r + t1;
...
{for bb:=0 to height do
  canvas.pixels[a,bb]:=c[cc];}

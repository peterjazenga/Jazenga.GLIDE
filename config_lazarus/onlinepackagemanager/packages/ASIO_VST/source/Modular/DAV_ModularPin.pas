...
constructor TCustomModularPin.Create(ACollection: TCollection);
begin
 inherited;
 FDisplayName := 'Pin ' + IntToStr(ACollection.Count);
end;
...
constructor TCustomModularIOPin.Create(ACollection: TCollection);
begin
 inherited;
 FDataType    := mdtSingle;
 FBufferSize  := 1;

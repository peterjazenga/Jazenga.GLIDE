...
The Delphi ASIO & VST Project is an open source solution for Delphi & Typhon 
...
to work with Typhon the LGPL that holds here is the same as the (modified) 
LGPL used for Typhon.

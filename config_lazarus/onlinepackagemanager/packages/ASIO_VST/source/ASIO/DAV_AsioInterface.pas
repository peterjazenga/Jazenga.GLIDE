...
{$IFDEF sPUREPASCAL}  // ct9999
function TStdCallAsio.Init(SysHandle: HWND): TASIOBool;
begin
...
{$IFDEF PUREPASCAL}  // ct9999
procedure TStdCallAsio.GetDriverName(Name: PAnsiChar);
begin
...
{$IFDEF PUREPASCAL}   // ct9999
function TStdCallAsio.GetDriverVersion: LongInt;
begin
...
{$IFDEF PUREPASCAL}  // ct9999
procedure TStdCallAsio.GetErrorMessage(ErrorString: PAnsiChar);
begin
...
{$IFDEF PUREPASCAL} // ct9999
function TStdCallAsio.Start: TASIOError;
begin
...
{$IFDEF PUREPASCAL}  // ct9999
function TStdCallAsio.Stop: TASIOError;
begin
...
{$IFDEF PUREPASCAL}   // ct9999
function TStdCallAsio.GetChannels(out NumInputChannels, NumOutputChannels: LongInt): TASIOError;
begin
...
{$IFDEF PUREPASCAL}  // ct9999
function TStdCallAsio.GetLatencies(out InputLatency, OutputLatency: LongInt): TASIOError;
begin
...
{$IFDEF PUREPASCAL}   // ct9999
function TStdCallAsio.GetBufferSize(out MinSize, MaxSize, PreferredSize, Granularity: LongInt): TASIOError;
begin
...
{$IFDEF PUREPASCAL}    // ct9999
function TStdCallAsio.CanSampleRate(SampleRate: TASIOSampleRate): TASIOError;
begin
...
{$IFDEF PUREPASCAL}    // ct9999
function TStdCallAsio.GetSampleRate(out SampleRate: TASIOSampleRate): TASIOError;
begin
...
{$IFDEF PUREPASCAL}    // ct9999
function TStdCallAsio.SetSampleRate(SampleRate: TASIOSampleRate): TASIOError;
begin
...
{$IFDEF PUREPASCAL}  // ct9999
function TStdCallAsio.GetClockSources(Clocks: PASIOClockSources; out NumSources: LongInt): TASIOError;
begin
...
{$IFDEF PUREPASCAL}       // ct9999
function TStdCallAsio.SetClockSource(Reference: LongInt): TAsioError;
begin
...
{$IFDEF PUREPASCAL}    // ct9999
function TStdCallAsio.GetChannelInfo(var Info: TASIOChannelInfo): TASIOError;
begin
...
{$IFDEF PUREPASCAL}   // ct9999
function TStdCallAsio.CreateBuffers(BufferInfos: PASIOBufferInfos; NumChannels, BufferSize: LongInt; const Callbacks: TASIOCallbacks): TASIOError;
begin
...
{$IFDEF PUREPASCAL}   // ct9999
function TStdCallAsio.DisposeBuffers: TASIOError;
begin
...
{$IFDEF PUREPASCAL} // ct9999
function TStdCallAsio.ControlPanel: TASIOError;
begin
...
{$IFDEF PUREPASCAL}    // ct9999
function TStdCallAsio.Future(Selector: LongInt; Opt: Pointer): TASIOError;
begin
...
{$IFDEF PUREPASCAL}    // ct9999
function TStdCallAsio.OutputReady: TASIOError;
begin

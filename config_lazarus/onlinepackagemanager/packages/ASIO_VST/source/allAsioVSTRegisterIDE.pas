...
//============================================= ct9999  for CodeTyphon
  ...
  NewSource := 'library VSTPlugin1;' + le
    ...
    + '  DAV_WinAmp,' + le
    + '  {$ENDIF}' + le
    + '  DAV_VSTBasicModule, DAV_VSTModule;' + le
    + le
    ...
    + le
    + 'begin' + le
    + '  Application.Title:=''VST Plugin'';' + le
    + '  Application.CreateForm(TVSTModule1, VSTModule1);' + le
    + '  Application.Run;' + le
    + 'end.';
  AProject.MainFile.SetSourceText(NewSource);

  // add
  AProject.AddPackageDependency('pl_asiovst');
//=======================================================
...
function TVSTModuleLibraryDescriptor.CreateStartFiles(AProject: TLazProject): TModalResult;
begin

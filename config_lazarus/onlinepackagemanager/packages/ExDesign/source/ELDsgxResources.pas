...
resourcestring
  ...
  RsDataItemRenderHasNoText = '(item does not support the IplDataItemText interface)';
  RsError = 'Error';
  RsFalse = 'False';
  RsTrue = 'True';
...
//=== JvAppIniStorage.pas ====================================================
resourcestring
  RsEReadValueFailed = 'TplAppIniFileStorage.ReadValue: Section undefined';
  RsEWriteValueFailed = 'TplAppIniFileStorage.WriteValue: Section undefined';
...
resourcestring
  ...
  RsJvAppStorageSynchronizeProcedureName = 'TplCustomAppStorage.Synchronize:';
...
resourcestring
  ...
  RsEDynControlEngineNotDefined = 'TplAppStorageSelectList.CreateDialog: DynControlEngine not defined!';
  RsEDynAppStorageNotDefined = 'TplAppStorageSelectList.GetSelectListPath: No AppStorage assigned';
...
//=== JvBevel.pas ============================================================
resourcestring
  RsEGradientDeprecated = 'Gradient is no longer available, use a TplGradient component instead';
...
resourcestring
  ...
  RsEInvalidAppearance = 'TplCustomMonthCalendar.CreateWithAppearance: cannot be created without valid Appearance';

//=== JvCaptionButton.pas ====================================================
resourcestring
  RsEOwnerMustBeTCustomForm = 'TplCaptionButton owner must be a TCustomForm';
...
resourcestring
  RsEBeginUnsupportedNestedCall = 'TplCustomCheckedMaskEdit.BeginInternalChange: Unsupported nested call!';
  RsEEndUnsupportedNestedCall = 'TplCustomCheckedMaskEdit.EndInternalChange: Unsupported nested call!';
...
resourcestring
  ...
  RsEInvalidTableName = 'TplCustomCsvDataSet.GetFileName - TableName property is not set';
...
//=== JvDropDownForm.pas =====================================================
resourcestring
  RsETplCustomDropDownFormCreateOwnerMus = 'TplCustomDropDownForm.Create: Owner must be a TCustomEdit';
...
resourcestring
  ...
  RsEOnlyAllowedOnForms = 'TplDSADialog is only allowed on forms';
  RsEAlreadyDSADialog = 'The form already has a TplDSADialog component';
...
resourcestring
  ...
  RsEUnsupportedControlClass = 'TplDynControlEngine.RegisterControl: Unsupported ControlClass "%s"';
  RsENoRegisteredControlClass = 'TplDynControlEngine.CreateControl: No Registered ControlClass "%s"';
  RsENoFocusControl = 'TplDynControlEngine.CreateLabelControlPanel: AFocusControl must be assigned';

//=== JvDynControlEngineDB.pas ===============================================
resourcestring
  RsEUnassignedField = 'TplDynControlEngineDB.GetFieldControlType: AField must be assigned';
  RsEUnassignedMultiple = 'TplDynControlEngineDB.CreateControlsFromDatasourceOnControl: ADataSource, ADataSource.Dataset and AControl must be assigned';
  RsEUnassignedDataSet = 'TplDynControlEngineDB.CreateControlsFromDatasourceOnControl: ADataSource.Dataset must be active';
...
//=== JvFooter.pas ===========================================================
resourcestring
  RsETplFooterBtnCanOnlyBePlacedOnATplFo = 'TplFooterBtn can only be placed on a TplFooter';
...
resourcestring
  ...
  RsEInconvertibleColor = 'TColor value $%.8X cannot be converted to TplFullColor';
...
//=== Jvg3DColors.pas ========================================================
resourcestring
  RsEOnlyOneInstanceOfTplg3DLocalColors = 'Cannot create more than one instance of Tplg3DLocalColors component';
...
//=== JvgCaption.pas =========================================================
resourcestring
  RsEOnlyOneInstanceOfTplgCaption = 'Cannot create more than one instance of TplgCaption component';
...
//=== JvGenetic.pas ==========================================================
resourcestring
  RsENoTest = 'TplGenetic: OnTestMember must be assigned';
...
//=== JvgHint.pas ============================================================
resourcestring
  RsEOnlyOneInstanceOfTplgHint = 'Cannot create more than one instance of TplgHint component';
...
resourcestring
  RsTplgSmallFontsDefenseCannotBeUsedWi = 'TplgSmallFontsDefense cannot be used with large fonts.';
...
resourcestring
  ...
  RsEDirectThreadCreationNotAllowed = 'Direct creation of a TplDeviceReadThread object is not allowed';
  RsEDirectHidDeviceCreationNotAllowed = 'Direct creation of a TplHidDevice object is not allowed';
  RsEDeviceCannotBeIdentified = 'Device cannot be identified';
  RsEDeviceCannotBeOpened = 'Device cannot be opened';
  RsEOnlyOneControllerPerProgram = 'Only one TplHidDeviceController allowed per program';
...
//=== JvHTTPGrabber.pas ======================================================
resourcestring
  RsAgent = 'TplHTTPGrabber Delphi Component';
...
resourcestring
  ...
  RsEJvAssertSetTopIndex = 'TplCustomInspector.SetTopIndex: unexpected MaxIdx <= -1';
  RsEJvAssertInspectorPainter = 'TplInspectorCustomCompoundItem.DivideRect: unexpected Inspector.Painter = nil';
  RsEJvAssertDataParent = 'TplInspectorSetMemberData.New: unexpected ADataParent = nil';
  RsEJvAssertParent = 'TplInspectorSetMemberData.New: unexpected AParent = nil';
  RsEJvAssertPropInfo = 'TplInspectorPropData.New: unexpected PropInfo = nil';
  RsEJvAssertClassInfo = 'TplInspectorPropData.New: unexpected ClassInfo = nil';
  RsEJvAssertINIFile = 'TplInspectorINIFileData.New: unexpected AINIFile = nil';

//=== JvInspXVCL.pas =========================================================
resourcestring
  RsENoNodeSpecified = 'TplInspectorxNodeData.New: No node specified';
...
resourcestring
  ...
  RsETagNotFound = 'TplCustomLinkLabel.UpdateDynamicTag: Tag not found';
...
//=== JvListView.pas =========================================================
resourcestring
  RsETooManyColumns = 'TplListView.GetColumnsOrder: too many columns';
...
resourcestring
  ...
  RsMultiAgent = 'TplMultiHTTPGrabber Delphi Component';
...
resourcestring
  ...
  RsENoParametersDefined = 'TplParameterList.ShowParameterDialog: No Parameters defined';
  RsEAddObjectWrongObjectType = 'TplParameterList.AddObject: Wrong object type';
  RsEAddObjectSearchNameNotDefined = 'TplParameterList.AddObject: SearchName not defined';
  RsEAddObjectDuplicateSearchNamesNotAllowed = 'TplParameterList.AddObject: Duplicate SearchNames ("%s") not allowed';
  RsECreateWinControlsOnWinControlDuplicateBeforeAfterNotAllowed = 'TplParameterList.CreateWinControlsOnWinControl: %s "%s" already used';
...
//=== JvPerfMon95.pas ========================================================
resourcestring
  RsWrongOS = 'TplPerfMon95 component is intended for Win95/98 only';
...
resourcestring
  ...
  RSProgramVersionInfo_PropertyHint_ProgramReleaseType = 'Release type of the version.'#13#10+
    ...
    'The type must be higher then AllowedReleaseType property of the TplProgramVersionCheck component';
...
//=== JvPropertyStore.pas ====================================================
resourcestring
  RsJvPropertyStoreMutexStorePropertiesProcedureName = 'TplCustomPropertyStore.StoreProperties:';
  RsJvPropertyStoreMutexLoadPropertiesProcedureName = 'TplCustomPropertyStore.LoadProperties:';
  RsJvPropertyStoreMutexLoadStorePropertiesProcedureName = 'TplCustomPropertyStore.LoadStoreProperties:';
...
resourcestring
  ...
  RsETplScrollMaxBandCanBePutOnlyIntoTpl = 'TplScrollMaxBand can be put only into TplScrollMax component';
  RsETplScrollMaxCanContainOnlyTplScroll = 'TplScrollMax can contain only TplScrollMaxBand components';
...
resourcestring
  RsENoFilesSpecifiedToTplSHFileOperatio = 'No files specified to TplSHFileOperation Execute function';
...
//=== JvSyncSplitter.pas =====================================================
resourcestring
  RsEInvalidPartner = 'TplSyncSplitter.SetPartner: cannot set Partner to Self!';
...
//=== JvSystemPopup.pas ======================================================
resourcestring
  RsEAlreadyHooked = 'TplSystemPopup.Hook: already hooked';
...
resourcestring
  ...
  RsEThisPropertyCannotBeChangedIfA = 'This property cannot be changed if a ' +
    'document exists';
  RsECouldNotCreateTplTFPrinterPageLayou = 'Could not create TplTFPrinterPageLayout ' +
...
//=== JvThreadDialog.pas =====================================================
resourcestring
  RsENotATplThread = 'TplCustomThreadDialogForm.SetConnectedThread: A thread must be a TplThread-Component';
...
//=== JvTimeList.pas =========================================================
resourcestring
  RsEOwnerMustBeTplTimerList = 'Owner of TplTimerEvents must be a TplTimerList';
...
resourcestring
  //SDiskFullError =
  //  'TplDiskFullDialog does not support removable media or network drives.';
...
resourcestring
  ...
  RsEInvalidParentControl = 'The Parent should be TplWizard or a descendant';
...
//=== JvPanel ================================================================
resourcestring
  RsDestroyingArrangeSettingsNotAllowed = 'Your code tried to destroy the TplPanel.ArrangeSettings ' +
    'objects leaving the panel in a broken state. Please fix your code by adding'#13#10#13#10 +
    '    if not ((Components[I] is TplArrangeSettings) or'#13#10 +
    '            (Components[I] is TplPanelHotTrackOptions)) then'#13#10#13#10 +

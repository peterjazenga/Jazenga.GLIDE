...
begin
  ...
  DestSize := ImagingCore.ScaleSizeToFit(CurSize, FitSize);  //=== ct9999 ============
...
begin
  case OptionId of
    ...
    ImagingLoadOverrideFormat, ImagingSaveOverrideFormat:
      Result := Iff(ImagingCore.IsImageFormatValid(TImageFormat(Value)),  //=== ct9999 ===========
...
procedure SetFileIO;
begin
  IO := TIOFunctions(FileIO);                         //=== ct9999 ===========
end;

procedure SetStreamIO;
begin
  IO := TIOFunctions(StreamIO);                      //=== ct9999 ===========
end;

procedure SetMemoryIO;
begin
  IO := TIOFunctions(MemoryIO);                      //=== ct9999 ===========
end;

procedure InitImageFormats;
begin
  ImagingCore.InitImageFormats(ImageFormatInfos);     //=== ct9999 ===========
end;

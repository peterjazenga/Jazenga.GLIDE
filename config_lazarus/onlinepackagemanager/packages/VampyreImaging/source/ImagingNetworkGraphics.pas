...
uses
  Types, SysUtils, Classes, ImagingTypes, ImagingCore, dzlib;     //=== ct9999 ==========
...
begin
  ...
  begin
    ...
    FileFormat.FMetadata.AddMetaItem(SMetaAnimationLoops, acTL.NumPlay);  //=== ct9999 ==========
  end;
  ...
  begin
    ...
    begin
      ...
      FileFormat.FMetadata.AddMetaItem(SMetaFrameDelay, Delay, I); //=== ct9999 ==========
    end;
  end;
end;

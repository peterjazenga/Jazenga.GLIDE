...
{$IFDEF COMPONENT_SET_LCL}
  ...
  LCLIntf,
{$ENDIF}
  ImagingTypes, ImagingCore, ImagingClasses;
...
begin
  for I := ImagingCore.GetFileFormatCount - 1 downto 0 do
    RegisterFileFormatAllInOne(ImagingCore.GetFileFormatAtIndex(I));
...
begin
  ...
  begin
    ...
    ImagingCore.InitImage(WorkData);
    ImagingCore.CloneImage(Data, WorkData);
    if Info.IsFloatingPoint or Info.HasAlphaChannel or Info.IsSpecial then
      ImagingCore.ConvertImage(WorkData, ifA8R8G8B8)
    else
    begin
{$IFDEF COMPONENT_SET_VCL}
      if Info.IsIndexed or Info.HasGrayChannel then
        ImagingCore.ConvertImage(WorkData, ifIndex8)
      else if Info.UsePixelFormat then
        ImagingCore.ConvertImage(WorkData, ifR5G6B5)
      else
        ImagingCore.ConvertImage(WorkData, ifR8G8B8);
{$ELSE}
        ImagingCore.ConvertImage(WorkData, ifA8R8G8B8);
{$ENDIF}
    end;
...
{$ENDIF}
  if WorkData.Bits <> Data.Bits then
    ImagingCore.FreeImage(WorkData);
end;
...
{$ENDIF}
  ...
  ImagingCore.NewImage(Bitmap.Width, Bitmap.Height, Format, Data);
  GetImageFormatInfo(Data.Format, Info);
...
begin
  ...
  begin
    ...
    ImagingCore.FreeImagesInArray(Arr);
  end
  else
...
begin
  ImagingCore.PushOptions;
  ImagingCore.SetOption(ImagingBitmapRLE, Ord(FUseRLE));
  inherited SaveToStream(Stream);
  ImagingCore.PopOptions;
end;
{$ENDIF}
...
begin
  ImagingCore.PushOptions;
  ImagingCore.SetOption(ImagingJpegQuality, FQuality);
  ImagingCore.SetOption(ImagingJpegProgressive, Ord(FProgressive));
  inherited SaveToStream(Stream);
  ImagingCore.PopOptions;
end;
...
begin
  ImagingCore.PushOptions;
  ImagingCore.SetOption(ImagingPNGPreFilter, FPreFilter);
  ImagingCore.SetOption(ImagingPNGCompressLevel, FCompressLevel);
  inherited SaveToStream(Stream);
  ImagingCore.PopOptions;
end;
{$ENDIF}
...
begin
  ImagingCore.PushOptions;
  ImagingCore.SetOption(ImagingTargaRLE, Ord(FUseRLE));
  inherited SaveToStream(Stream);
  ImagingCore.PopOptions;
end;
{$ENDIF}
...
begin
  ...
  ImagingCore.PushOptions;
  ImagingCore.SetOption(ImagingDDSSaveCubeMap, Ord(False));
  ImagingCore.SetOption(ImagingDDSSaveVolume, Ord(False));
  ImagingCore.SetOption(ImagingDDSSaveMipMapCount, 1);
  ImagingCore.SetOption(ImagingDDSSaveDepth, 1);
  inherited SaveToStream(Stream);
  ImagingCore.PopOptions;
end;
{$ENDIF}
...
begin
  ImagingCore.PushOptions;
  ImagingCore.SetOption(ImagingMNGLossyCompression, Ord(FLossyCompression));
  ImagingCore.SetOption(ImagingMNGLossyAlpha, Ord(FLossyAlpha));
  ImagingCore.SetOption(ImagingMNGPreFilter, FPreFilter);
  ImagingCore.SetOption(ImagingMNGCompressLevel, FCompressLevel);
  ImagingCore.SetOption(ImagingMNGQuality, FQuality);
  ImagingCore.SetOption(ImagingMNGProgressive, Ord(FProgressive));
  inherited SaveToStream(Stream);
  ImagingCore.PopOptions;
end;
{$ENDIF}
...
begin
  ImagingCore.PushOptions;
  ImagingCore.SetOption(ImagingJNGLossyALpha, Ord(FLossyAlpha));
  ImagingCore.SetOption(ImagingJNGAlphaPreFilter, FAlphaPreFilter);
  ImagingCore.SetOption(ImagingJNGAlphaCompressLevel, FAlphaCompressLevel);
  ImagingCore.SetOption(ImagingJNGQuality, FQuality);
  ImagingCore.SetOption(ImagingJNGProgressive, Ord(FProgressive));
  inherited SaveToStream(Stream);
  ImagingCore.PopOptions;
end;
{$ENDIF}

...
type
   ...
   TOpenGL2DCanvas = class;
   TAfterRendering = procedure(Sender: TOpenGL2DCanvas) of object;
   ...
   TOpenGL2DCanvas = class(TComponent)
   private
      FHRC: HGLRC;
      FControl: TControl;
   ...
   public
      ...
      Procedure CreateEX(AControl: TControl; RenderToBmp: Boolean = True;
      ...
      function  RenderingBegin(BackgroundColor: TColor = clWhite): TOpenGL2DCanvas;
      ...
      { You can either build draw lists in Rendering process or not.
        ...
        the list.  }
      function CreateList(var ListID: GLuint; Range: GLuint = 1): TOpenGL2DCanvas;
      function DeleteList(ListID: GLuint; Range: GLuint = 1): TOpenGL2DCanvas;
      function ListBegin(ListID: GLuint; Offset: GLuint = 0; Execute: Boolean = False;
         IgnoreColor: Boolean = True): TOpenGL2DCanvas;
      function ListEnd: TOpenGL2DCanvas;
      function ListExecute(ListID: GLuint; Offset: GLuint = 0): TOpenGL2DCanvas; overload;
      function ListExecute(ListID: GLuint; Offset: GLuint; Color: ARGB;
         PenWidth: Single): TOpenGL2DCanvas; overload; // PenWidth <= 0 for no change
      ...
      ///////////////////////////////////////////////
      function BeginUpdateTransformation: TOpenGL2DCanvas;
      function EndUpdateTransformation: TOpenGL2DCanvas;

      // Use transformation for rendering. Not effective for TextOut.
      function SetTransformation(sx, sy, tx, ty, r: Single): TOpenGL2DCanvas; // Scale, Translate, Rotation
      function SetMatrix(const m11, m12, m13, m21, m22, m23, m31, m32, m33,
                         dx, dy: Single; Backup: Boolean = True): TOpenGL2DCanvas;
      function ResetBackupMatrix: TOpenGL2DCanvas;

      function ResetTransformation: TOpenGL2DCanvas;
      function PopMatrix: TOpenGL2DCanvas; // Cancel last transformation
      function SetEqualScale(value: Single): TOpenGL2DCanvas;
      function ScaleMatrix(x, y: Single): TOpenGL2DCanvas;
      function TranslateMatrix(x, y: Single): TOpenGL2DCanvas;
      function RotateMatrix(angle: Single): TOpenGL2DCanvas;
      function SetScaleX(value: Single): TOpenGL2DCanvas;
      function SetScaleY(value: Single): TOpenGL2DCanvas;
      function SetTranslateX(value: Single): TOpenGL2DCanvas;
      function SetTranslateY(value: Single): TOpenGL2DCanvas;
      function SetRotation(value: Single): TOpenGL2DCanvas;

      function ConvertScreenToWorld(x, y: Integer): TGLPointF; // GDI coordinate where (0, 0) is Left-Top
      function UpdateTransformation: TOpenGL2DCanvas; // You can maually force update transformation

      ///////////////////////////////////////////////
      function SetBlendState(value: Boolean): TOpenGL2DCanvas; // Use this to enable or disable GL_BLEND, GL_BLEND is enabled by default.

      ///////////////////////////////////////////////
      function SetPenColorWin(value: TColor; alpha: Byte = 255; Sync: Boolean = True): TOpenGL2DCanvas;
      function SetBrushColorWin(value: TColor; alpha: Byte = 255; Sync: Boolean = True): TOpenGL2DCanvas;
      function SetPenColor(value: ARGB): TOpenGL2DCanvas; overload; // for linked process
      function SetBrushColor(value: ARGB): TOpenGL2DCanvas; overload; // for linked process
      // For quick OpenGL color assignment. Sync = True, update FPenColorARGB or FBrushColorARGB
      function SetPenColor(const value: TColorVector; Sync: Boolean = False): TOpenGL2DCanvas; overload;
      function SetBrushColor(const value: TColorVector; Sync: Boolean = False): TOpenGL2DCanvas; overload;
      function SetPenWidth(value: Single): TOpenGL2DCanvas; // for linked process

      function LineStipple(factor: Integer; pattern: word): TOpenGL2DCanvas; overload;
      function LineStipple(style: TLineStippleStyle; enlarge: Byte = 2): TOpenGL2DCanvas; overload;
      function LineStippleEnd: TOpenGL2DCanvas;

      function Line(const x1, y1, x2, y2: Integer): TOpenGL2DCanvas; overload;
      function Line(const x1, y1, x2, y2: Single): TOpenGL2DCanvas; overload;
      function BeginLines: TOpenGL2DCanvas; // Remember to call EndLines
      function Lines(const x1, y1, x2, y2: Integer): TOpenGL2DCanvas; overload;
      function Lines(const x1, y1, x2, y2: Single): TOpenGL2DCanvas; overload;
      function EndLines: TOpenGL2DCanvas;
      function Lines(const points: TGLPointsF; count: Integer): TOpenGL2DCanvas; overload;
      function Lines(const points: TGLPointsI; count: Integer): TOpenGL2DCanvas; overload;

      function Polyline(const points: TGLPointsF; count: Integer): TOpenGL2DCanvas; overload;
      function Polyline(const points: TGLPointsI; count: Integer): TOpenGL2DCanvas; overload;
      function Polygon(const points: TGLPointsF; count: Integer): TOpenGL2DCanvas; overload;
      function Polygon(const points: TGLPointsI; count: Integer): TOpenGL2DCanvas; overload;
      function FillPolygon(const points: TGLPointsF; count: Integer; Border: Boolean = False): TOpenGL2DCanvas; overload;
      function FillPolygon(const points: TGLPointsI; count: Integer; Border: Boolean = False): TOpenGL2DCanvas; overload;

      function Curve(const points: TGLPointsF; count: Integer; tension: Single = 0.5): TOpenGL2DCanvas; overload;
      function Curve(const points: TGLPointsI; count: Integer; tension: Single = 0.5): TOpenGL2DCanvas; overload;
      function ClosedCurve(const points: TGLPointsF; count: Integer; tension: Single = 0.5): TOpenGL2DCanvas; overload;
      function ClosedCurve(const points: TGLPointsI; count: Integer; tension: Single = 0.5): TOpenGL2DCanvas; overload;
      function FillClosedCurve(const points: TGLPointsF; count: Integer;
                               Border: Boolean = False; tension: Single = 0.5): TOpenGL2DCanvas; overload;
      function FillClosedCurve(const points: TGLPointsI; count: Integer;
                               Border: Boolean = False; tension: Single = 0.5): TOpenGL2DCanvas; overload;

      function Bezier(const x1, y1, x2, y2, x3, y3, x4, y4: Integer): TOpenGL2DCanvas; overload;
      function Bezier(const x1, y1, x2, y2, x3, y3, x4, y4: Single): TOpenGL2DCanvas; overload;
      function PolyBezier(const points: TGLPointsI; count: Integer): TOpenGL2DCanvas; overload;
      function PolyBezier(const points: TGLPointsF; count: Integer): TOpenGL2DCanvas; overload;

      // x, y, xRadius, yRadius specify an ellipse. startAngle and sweepAngle specify the range of curve.
      function Arc(const x, y, xRadius, yRadius: Single; startAngle, sweepAngle: Single): TOpenGL2DCanvas;
      function FillPie(const x, y, xRadius, yRadius: Single;
                        startAngle, sweepAngle: Single; Border: Boolean = False): TOpenGL2DCanvas;

      // Plots a pixel at given coordinate
      function PlotPixel(const x, y: Integer): TOpenGL2DCanvas; overload;
      function PlotPixel(const x, y: Single): TOpenGL2DCanvas; overload;
      function BeginPixels: TOpenGL2DCanvas; // Remember to call EndPixels
      function Pixels(const x, y: Integer): TOpenGL2DCanvas; overload;
      function Pixels(const x, y: Single): TOpenGL2DCanvas; overload;
      function EndPixels: TOpenGL2DCanvas;

      // Draw the (x1,y1)-(x2, y2) rectangle's frame (border). }
      function FrameRect(const x1, y1, x2, y2: Integer): TOpenGL2DCanvas; overload;
      function FrameRect(const x1, y1, x2, y2: Single): TOpenGL2DCanvas; overload;
      // Draw the (x1,y1)-(x2, y2) rectangle (filled with BrushColor)
      function FillRect(const x1, y1, x2, y2: Integer; Border: Boolean = False): TOpenGL2DCanvas; overload;
      function FillRect(const x1, y1, x2, y2: Single; Border: Boolean = False): TOpenGL2DCanvas; overload;

      function Triangle(const x1, y1, x2, y2, x3, y3: Integer): TOpenGL2DCanvas; overload;
      function Triangle(const x1, y1, x2, y2, x3, y3: Single): TOpenGL2DCanvas; overload;
      function FillTriangle(const x1, y1, x2, y2, x3, y3: Integer; Border: Boolean = False): TOpenGL2DCanvas; overload;
      function FillTriangle(const x1, y1, x2, y2, x3, y3: Single; Border: Boolean = False): TOpenGL2DCanvas; overload;

      // Draws an ellipse with (x1,y1)-(x2, y2) bounding rectangle.
      function EllipseRect(const x1, y1, x2, y2 : Single): TOpenGL2DCanvas; overload;
      // Draws and ellipse centered at (x, y) with given radiuses.
      function Ellipse(const x, y, xRadius, yRadius: Single): TOpenGL2DCanvas; overload;
      function FillEllipseRect(const x1, y1, x2, y2: Single; Border: Boolean = False): TOpenGL2DCanvas; overload;
      function FillEllipse(const x, y, xRadius, yRadius: Single; Border: Boolean = False): TOpenGL2DCanvas; overload;

      procedure RecreateDefaultFont;
      // Output only ASCII chars, other chars will be ignored automatically
      function TextOutASCII(const text: string; x, y: Integer; Font: TGLFont = nil): TOpenGL2DCanvas; // Use this for ASCII chars for efficiency
      // Output any string but slow
      function TextOut(const text: WideString; x, y: Integer; Font: TGLFont = nil): TOpenGL2DCanvas;

      function BuildTexture(bmp: TBitmap; var texId: GLuint): TOpenGL2DCanvas;
      function DeleteTexture(texId: GLuint): TOpenGL2DCanvas;

      //The difference between DrawBitmap and DrawBitmapTex is that DrawBitmapTex supports transformation}
      function DrawBitmap(bmp: TBitmap; x, y: Integer; xZoom: Single = 1.0; yZoom: Single = 1.0): TOpenGL2DCanvas; overload;
      function DrawBitmapTex(bmp: TBitmap; x, y, w, h: Integer): TOpenGL2DCanvas; overload;
      function DrawBitmapTex(texId: GLuint; x, y, w, h: Integer): TOpenGL2DCanvas; overload;
...
Procedure TOpenGL2DCanvas.CreateEX(AControl: TControl; RenderToBmp: Boolean = True;
   Antialiasing: Boolean = True; UseTransformStack: Boolean = False;
   IgnorePenWidthFactor: Boolean = False; InvertY: Boolean = True);
begin
   FControl := AControl;
...
constructor TOpenGL2DCanvas.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TOpenGL2DCanvas.Destroy;
begin
   FreeBufferBMP;
...
procedure TOpenGL2DCanvas.CreateBufferBMP;
var
   bmi: BITMAPINFO;
   pbits: ^DWORD;
begin
...
procedure TOpenGL2DCanvas.FreeBufferBMP;
begin
...
procedure TOpenGL2DCanvas.PresentBufferBMP(DC: HDC);
begin
...
procedure TOpenGL2DCanvas.FSetPenColor(Value: ARGB);
begin
...
procedure TOpenGL2DCanvas.FSetBrushColor(Value: ARGB);
begin
...
procedure TOpenGL2DCanvas.FSetPenWidth(Value: Single);
begin
   FPenWidth := Value;
...
procedure TOpenGL2DCanvas.InitOpenGL;
var
...
procedure TOpenGL2DCanvas.ActivateSelf;
begin
   wglMakeCurrent(FBufferHDC, FHRC);
...
procedure TOpenGL2DCanvas.ApplyTransformation;
...
procedure TOpenGL2DCanvas.DefaultFontNotify;
var
   i: Integer;
begin
...
procedure TOpenGL2DCanvas.FSetAntialiasing(value: Boolean);
begin
   if value then
   begin
      glEnable(GL_SMOOTH);
...
procedure TOpenGL2DCanvas.FSetScaleX(value: Single);
begin
   FScaleX := value;
...
procedure TOpenGL2DCanvas.FSetScaleY(value: Single);
begin
   FScaleY := value;
   if FTransformationUpdateCount = 0 then
      ApplyTransformation;
...
procedure TOpenGL2DCanvas.FSetTranslateX(value: Single);
begin
   FTranslateX := value;
   if FTransformationUpdateCount = 0 then
      ApplyTransformation;
...
procedure TOpenGL2DCanvas.FSetTranslateY(value: Single);
begin
   FTranslateY := value;
   if FTransformationUpdateCount = 0 then
      ApplyTransformation;
...
procedure TOpenGL2DCanvas.FSetRotation(value: Single);
begin
   FRotation := value;
   if FTransformationUpdateCount = 0 then
      ApplyTransformation;
...
function TOpenGL2DCanvas.RenderingBegin(BackgroundColor: TColor = clWhite): TOpenGL2DCanvas;
var
   bkCol: TColorVector;
begin
   Result := Self;
...
procedure TOpenGL2DCanvas.RenderingEnd;
begin
   if FRenderToBMP then
   begin
      glFinish;
...
function TOpenGL2DCanvas.CreateList(var ListID: GLuint; Range: GLuint = 1): TOpenGL2DCanvas;
begin
   if Range >= 1 then
   begin
      {$IFDEF MultiCanvases}
...
function TOpenGL2DCanvas.DeleteList(ListID: GLuint; Range: GLuint = 1): TOpenGL2DCanvas;
begin
   glDeleteLists(ListID, Range);
   Result := Self;
end;

function TOpenGL2DCanvas.ListBegin(ListID: GLuint; Offset: GLuint = 0;
   Execute: Boolean = False; IgnoreColor: Boolean = True): TOpenGL2DCanvas;
begin
   Result := Self;
...
function TOpenGL2DCanvas.ListEnd: TOpenGL2DCanvas;
begin
   glEndList;
   Dec(FListLevel);
...
function TOpenGL2DCanvas.ListExecute(ListID: GLuint; Offset: GLuint = 0): TOpenGL2DCanvas;
begin
   if FRendering then
...
function TOpenGL2DCanvas.ListExecute(ListID: GLuint; Offset: GLuint; Color: ARGB;
   PenWidth: Single): TOpenGL2DCanvas;
var
...
procedure TOpenGL2DCanvas.Recreate;
begin
   // Reinitialize opengl
   if FRenderToBmp then
      CreateBufferBMP
...
procedure TOpenGL2DCanvas.OnControlPaint;
var
   DC: HDC;
begin
   if FRenderToBmp then
...
procedure TOpenGL2DCanvas.DrawTo(DC: HDC);
begin
   if FRenderToBmp then
...
procedure TOpenGL2DCanvas.StretchDrawTo(DC: HDC; X, Y, W, H: Integer);
begin
   if FRenderToBmp then
      StretchBlt(DC, X, Y, W, H, FBufferHDC, 0, 0, FBufferWidth, FBufferHeight, SRCCOPY);
end;

function TOpenGL2DCanvas.BeginUpdateTransformation: TOpenGL2DCanvas;
begin
   Inc(FTransformationUpdateCount);
   Result := Self;
end;

function TOpenGL2DCanvas.EndUpdateTransformation: TOpenGL2DCanvas;
begin
...
function TOpenGL2DCanvas.SetTransformation(sx, sy, tx, ty, r: Single): TOpenGL2DCanvas;
begin
...
function TOpenGL2DCanvas.SetMatrix(const m11, m12, m13, m21, m22, m23, m31, m32, m33,
   dx, dy: Single; Backup: Boolean = True): TOpenGL2DCanvas;
var
   AMatrix: TMatrix4f;
begin
...
function TOpenGL2DCanvas.ResetBackupMatrix: TOpenGL2DCanvas;
begin
   Result := Self;
   if not Rendering then
      Exit;
...
function TOpenGL2DCanvas.ResetTransformation: TOpenGL2DCanvas;
begin
   FStackTop := -1;
   FScaleX := 1.0;
   FScaleY := 1.0;
...
function TOpenGL2DCanvas.PopMatrix: TOpenGL2DCanvas;
begin
   if FStackTop >= 0 then
      Dec(FStackTop);
   if FTransformationUpdateCount = 0 then
...
function TOpenGL2DCanvas.SetEqualScale(value: Single): TOpenGL2DCanvas;
begin
...
function TOpenGL2DCanvas.ScaleMatrix(x, y: Single): TOpenGL2DCanvas;
begin
...
function TOpenGL2DCanvas.TranslateMatrix(x, y: Single): TOpenGL2DCanvas;
begin
   if FStackTop < TransformStackTop then
   begin
      Inc(FStackTop);
...
function TOpenGL2DCanvas.RotateMatrix(angle: Single): TOpenGL2DCanvas;
begin
   if FStackTop < TransformStackTop then
   begin
      Inc(FStackTop);
...
function TOpenGL2DCanvas.SetScaleX(value: Single): TOpenGL2DCanvas;
begin
   ScaleX := value;
   Result := Self;
end;

function TOpenGL2DCanvas.SetScaleY(value: Single): TOpenGL2DCanvas;
begin
   ScaleY := value;
   Result := Self;
end;

function TOpenGL2DCanvas.SetTranslateX(value: Single): TOpenGL2DCanvas;
begin
   TranslateX := value;
   Result := Self;
end;

function TOpenGL2DCanvas.SetTranslateY(value: Single): TOpenGL2DCanvas;
begin
   TranslateY := value;
   Result := Self;
end;

function TOpenGL2DCanvas.SetRotation(value: Single): TOpenGL2DCanvas;
begin
   Rotation := value;
   Result := Self;
end;

function TOpenGL2DCanvas.ConvertScreenToWorld(x, y: Integer): TGLPointF;
var
...
begin
   ...
   gluUnProject(x, Viewport[3] - y, 0, @ModelMatrix[0], @ProjMatrix[0], @Viewport[0], @ox, @oy, @oz);
   Result.X := ox;
   Result.Y := oy;
end;

function TOpenGL2DCanvas.UpdateTransformation: TOpenGL2DCanvas;
begin
   ApplyTransformation;
   PenWidth := FPenWidth;
   Result := Self;
...
function TOpenGL2DCanvas.SetBlendState(value: Boolean): TOpenGL2DCanvas;
begin
   if value then
      glEnable(GL_BLEND)
   else
...
function TOpenGL2DCanvas.SetPenColorWin(value: TColor; alpha: Byte = 255; Sync: Boolean = True): TOpenGL2DCanvas;
begin
   if Sync then
...
function TOpenGL2DCanvas.SetBrushColorWin(value: TColor; alpha: Byte = 255; Sync: Boolean = True): TOpenGL2DCanvas;
begin
   if Sync then
...
function TOpenGL2DCanvas.SetPenColor(value: ARGB): TOpenGL2DCanvas;
begin
   FSetPenColor(value);
   Result := Self;
end;

function TOpenGL2DCanvas.SetBrushColor(value: ARGB): TOpenGL2DCanvas;
begin
   FSetBrushColor(value);
   Result := Self;
end;

function TOpenGL2DCanvas.SetPenColor(const value: TColorVector; Sync: Boolean = False): TOpenGL2DCanvas;
begin
   glColor4fv(@value);
   FPenColor := value;
   if Sync then
...
function TOpenGL2DCanvas.SetBrushColor(const value: TColorVector; Sync: Boolean = False): TOpenGL2DCanvas;
begin
   FBrushColor := value;
   if Sync then
...
function TOpenGL2DCanvas.SetPenWidth(value: Single): TOpenGL2DCanvas; // for linked process
begin
   FSetPenWidth(value);
   Result := Self;
end;

function TOpenGL2DCanvas.LineStipple(factor: Integer; pattern: word): TOpenGL2DCanvas;
begin
...
function TOpenGL2DCanvas.LineStipple(style: TLineStippleStyle; enlarge: Byte = 2): TOpenGL2DCanvas;
begin
   case style of
...
function TOpenGL2DCanvas.LineStippleEnd: TOpenGL2DCanvas;
begin
   glDisable(GL_LINE_STIPPLE);
   Result := Self;
end;

function TOpenGL2DCanvas.Line(const x1, y1, x2, y2: Integer): TOpenGL2DCanvas;
begin
   glBegin(GL_LINES);
   glVertex2i(x1, y1);
   glVertex2i(x2, y2);
...
function TOpenGL2DCanvas.Line(const x1, y1, x2, y2: Single): TOpenGL2DCanvas;
begin
   glBegin(GL_LINES);
   glVertex2f(x1, y1);
   glVertex2f(x2, y2);
...
function TOpenGL2DCanvas.BeginLines: TOpenGL2DCanvas;
begin
   glBegin(GL_LINES);
   Result := Self;
end;

function TOpenGL2DCanvas.Lines(const x1, y1, x2, y2: Integer): TOpenGL2DCanvas;
begin
   glVertex2i(x1, y1);
   glVertex2i(x2, y2);
   Result := Self;
...
function TOpenGL2DCanvas.Lines(const x1, y1, x2, y2: Single): TOpenGL2DCanvas;
begin
   glVertex2f(x1, y1);
   glVertex2f(x2, y2);
   Result := Self;
...
function TOpenGL2DCanvas.EndLines: TOpenGL2DCanvas;
begin
   glEnd;
   Result := Self;
end;

function TOpenGL2DCanvas.Lines(const points: TGLPointsF; count: Integer): TOpenGL2DCanvas;
var
   i: Integer;
begin
   glBegin(GL_LINES);
...
function TOpenGL2DCanvas.Lines(const points: TGLPointsI; count: Integer): TOpenGL2DCanvas;
var
   i: Integer;
begin
   glBegin(GL_LINES);
...
function TOpenGL2DCanvas.Polyline(const points: TGLPointsF; count: Integer): TOpenGL2DCanvas;
var
   i: Integer;
begin
   if count > 1 then
...
function TOpenGL2DCanvas.Polygon(const points: TGLPointsF; count: Integer): TOpenGL2DCanvas;
var
   i: Integer;
begin
   if count > 1 then
...
function TOpenGL2DCanvas.Polyline(const points: TGLPointsI; count: Integer): TOpenGL2DCanvas;
var
   i: Integer;
begin
   if count > 1 then
...
function TOpenGL2DCanvas.Polygon(const points: TGLPointsI; count: Integer): TOpenGL2DCanvas;
var
   i: Integer;
begin
   if count > 1 then
...
function TOpenGL2DCanvas.FillPolygon(const points: TGLPointsF; count: Integer;
   Border: Boolean = False): TOpenGL2DCanvas;
var
   i: Integer;
begin
   if count > 1 then
...
function TOpenGL2DCanvas.FillPolygon(const points: TGLPointsI; count: Integer;
   Border: Boolean = False): TOpenGL2DCanvas;
var
   i: Integer;
begin
...
function TOpenGL2DCanvas.Curve(const points: TGLPointsF; count: Integer;
   tension: Single = 0.5): TOpenGL2DCanvas;
var
   pt2: TGLPointsF;
   pt2Count: Integer;
begin
...
function TOpenGL2DCanvas.Curve(const points: TGLPointsI; count: Integer;
   tension: Single = 0.5): TOpenGL2DCanvas;
var
   i: Integer;
   pfs: TGLPointsF;
...
function TOpenGL2DCanvas.ClosedCurve(const points: TGLPointsF; count: Integer;
   tension: Single = 0.5): TOpenGL2DCanvas;
var
   ps: TGLPointsF;
begin
...
function TOpenGL2DCanvas.ClosedCurve(const points: TGLPointsI; count: Integer;
   tension: Single = 0.5): TOpenGL2DCanvas;
var
   i: Integer;
   ps: TGLPointsF;
...
function TOpenGL2DCanvas.FillClosedCurve(const points: TGLPointsF; count: Integer;
   Border: Boolean = False; tension: Single = 0.5): TOpenGL2DCanvas;
var
   ps, pt2: TGLPointsF;
   pt2Count: Integer;
begin
...
function TOpenGL2DCanvas.FillClosedCurve(const points: TGLPointsI; count: Integer;
   Border: Boolean = False; tension: Single = 0.5): TOpenGL2DCanvas;
var
   i: Integer;
   ps, pt2: TGLPointsF;
...
function TOpenGL2DCanvas.Bezier(const x1, y1, x2, y2, x3, y3, x4, y4: Integer): TOpenGL2DCanvas;
var
   pt: TGDIBezierPoints;
   pt2: TGLPointsF;
   ptOut: Integer;
...
function TOpenGL2DCanvas.Bezier(const x1, y1, x2, y2, x3, y3, x4, y4: Single): TOpenGL2DCanvas;
var
   pt: TGDIBezierPoints;
   pt2: TGLPointsF;
   ptOut: Integer;
...
function TOpenGL2DCanvas.PolyBezier(const points: TGLPointsI; count: Integer): TOpenGL2DCanvas;
var
   i: Integer;
   ps, pt2: TGLPointsF;
   pt2Count: Integer;
...
function TOpenGL2DCanvas.PolyBezier(const points: TGLPointsF; count: Integer): TOpenGL2DCanvas;
var
   ps2Count: Integer;
   ps2: TGLPointsF;
begin
...
procedure add_arc_part(pt: PGdiArcPointsSegment; const x1, y1, x2, y2: Single; startangle, endangle: Single; write_first: Boolean);
var
   i: Integer;
...
function arc2polybezier(var points: TGdiArcPoints; const x1, y1, x2, y2: Single; var startAngle, sweepAngle: Single): Integer;
var
   i, count: Integer;
...
begin
    ...
    begin
       ...
       if sweepAngle > 0.0 then
          end_angle := MinFloat(start_angle + PiDiv2, endAngle)
       else
          end_angle := MaxFloat(start_angle - PiDiv2, endAngle);
...
function TOpenGL2DCanvas.Arc(const x, y, xRadius, yRadius: Single;
   startAngle, sweepAngle: Single): TOpenGL2DCanvas;
var
   num_pts: Integer;
...
function TOpenGL2DCanvas.FillPie(const x, y, xRadius, yRadius: Single;
   startAngle, sweepAngle: Single; Border: Boolean = False): TOpenGL2DCanvas;
var
   i, num_pts: Integer;
   points: TGdiArcPoints;
...
function TOpenGL2DCanvas.PlotPixel(const x, y: Integer): TOpenGL2DCanvas;
begin
   glBegin(GL_POINTS);
   glVertex2i(x, y);
   glEnd;
...
function TOpenGL2DCanvas.PlotPixel(const x, y: Single): TOpenGL2DCanvas;
begin
   glBegin(GL_POINTS);
   glVertex2f(x, y);
   glEnd;
...
function TOpenGL2DCanvas.BeginPixels: TOpenGL2DCanvas;
begin
   glBegin(GL_POINTS);
   Result := Self;
end;

function TOpenGL2DCanvas.Pixels(const x, y: Integer): TOpenGL2DCanvas;
begin
   glVertex2i(x, y);
   Result := Self;
end;

function TOpenGL2DCanvas.Pixels(const x, y: Single): TOpenGL2DCanvas;
begin
   glVertex2f(x, y);
   Result := Self;
end;

function TOpenGL2DCanvas.EndPixels: TOpenGL2DCanvas;
begin
   glEnd;
   Result := Self;
end;

function TOpenGL2DCanvas.FrameRect(const x1, y1, x2, y2: Integer): TOpenGL2DCanvas;
begin
   glBegin(GL_LINE_LOOP);
   glVertex2i(x1, y1);
   glVertex2i(x2, y1);
...
function TOpenGL2DCanvas.FrameRect(const x1, y1, x2, y2: Single): TOpenGL2DCanvas;
begin
   glBegin(GL_LINE_LOOP);
   glVertex2f(x1, y1);
   glVertex2f(x2, y1);
...
function TOpenGL2DCanvas.FillRect(const x1, y1, x2, y2: Integer; Border: Boolean = False): TOpenGL2DCanvas;
begin
   if not FIgnoreColor then 
      glColor4fv(@FBrushColor);
   glRecti(x1, y1, x2, y2);
...
function TOpenGL2DCanvas.FillRect(const x1, y1, x2, y2: Single; Border: Boolean = False): TOpenGL2DCanvas;
begin
   if not FIgnoreColor then 
      glColor4fv(@FBrushColor);
   glRectf(x1, y1, x2, y2);
...
function TOpenGL2DCanvas.Triangle(const x1, y1, x2, y2, x3, y3: Integer): TOpenGL2DCanvas;
begin
   glBegin(GL_LINE_LOOP);
   glVertex2i(x1, y1);
   glVertex2i(x2, y2);
...
function TOpenGL2DCanvas.Triangle(const x1, y1, x2, y2, x3, y3: Single): TOpenGL2DCanvas;
begin
   glBegin(GL_LINE_LOOP);
   glVertex2f(x1, y1);
   glVertex2f(x2, y2);
...
function TOpenGL2DCanvas.FillTriangle(const x1, y1, x2, y2, x3, y3: Integer;
   Border: Boolean = False): TOpenGL2DCanvas;
begin
   if not FIgnoreColor then 
      glColor4fv(@FBrushColor);
...
function TOpenGL2DCanvas.FillTriangle(const x1, y1, x2, y2, x3, y3: Single;
   Border: Boolean = False): TOpenGL2DCanvas;
begin
   if not FIgnoreColor then 
      glColor4fv(@FBrushColor);
...
procedure TOpenGL2DCanvas.EllipseVertices(const x, y, xRadius, yRadius: Single);
var
   i, n: Integer;
   s, c: TSingleArray;
begin
...
function TOpenGL2DCanvas.EllipseRect(const x1, y1, x2, y2: Single): TOpenGL2DCanvas;
begin
   Ellipse((x1 + x2) * 0.5, (y1 + y2) * 0.5, Abs(x2 - x1) * 0.5, Abs(y2 - y1) * 0.5);
   Result := Self;
end;

function TOpenGL2DCanvas.Ellipse(const x, y, xRadius, yRadius: Single): TOpenGL2DCanvas;
begin
   glBegin(GL_LINE_STRIP);
...
function TOpenGL2DCanvas.FillEllipseRect(const x1, y1, x2, y2: Single;
   Border: Boolean = False): TOpenGL2DCanvas;
begin
...
function TOpenGL2DCanvas.FillEllipse(const x, y, xRadius, yRadius: Single;
   Border: Boolean = False): TOpenGL2DCanvas;
begin
   if not FIgnoreColor then
      glColor4fv(@FBrushColor);
...
procedure TOpenGL2DCanvas.RecreateDefaultFont;
begin
...
function TOpenGL2DCanvas.TextOutASCII(const text: string; x, y: Integer;
   Font: TGLFont = nil): TOpenGL2DCanvas;
var
   i: Integer;
   GLList: GLuint;
...
function TOpenGL2DCanvas.TextOut(const text: WideString; x, y: Integer;
   Font: TGLFont = nil): TOpenGL2DCanvas;
var
   i: Integer;
   list: GLuint;
...
function TOpenGL2DCanvas.BuildTexture(bmp: TBitmap; var texId: GLuint): TOpenGL2DCanvas; // Creates Texture From A Bitmap File
var
   bmpInfo: BITMAP;
begin
...
function TOpenGL2DCanvas.DeleteTexture(texId: GLuint): TOpenGL2DCanvas;
begin
   glDeleteTextures(1, @texId);
   Result := Self;
end;

function TOpenGL2DCanvas.DrawBitmap(bmp: TBitmap; x, y: Integer;
   xZoom: Single = 1.0; yZoom: Single = 1.0): TOpenGL2DCanvas;
var
   bmpInfo: BITMAP;
begin
   GetObject(bmp.Handle, SizeOf(bmpInfo), @bmpInfo);
...
function TOpenGL2DCanvas.DrawBitmapTex(bmp: TBitmap; x, y, w, h: Integer): TOpenGL2DCanvas;
var
   tex: GLuint;
begin
...
function TOpenGL2DCanvas.DrawBitmapTex(texId: GLuint; x, y, w, h: Integer): TOpenGL2DCanvas;
begin
   glColor3f(1.0, 1.0, 1.0);
   glDisable(GL_BLEND);
   glEnable(GL_TEXTURE_2D);

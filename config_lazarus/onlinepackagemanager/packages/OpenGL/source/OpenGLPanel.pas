...
type
  TOpenGLPanelMakeCurrentEvent = procedure(Sender: TObject; var Allow: boolean) of object;  

  TOpenGLPanelOption = (ocoMacRetinaMode, ocoRenderAtDesignTime);
  TOpenGLPanelOptions = set of TOpenGLPanelOption;
  ...
  private
    ...
    FOnMakeCurrent: TOpenGLPanelMakeCurrentEvent;
    ...
    procedure SetOptions(AValue: TOpenGLPanelOptions);
  ...
  public
    ...
    property OnMakeCurrent: TOpenGLPanelMakeCurrentEvent read FOnMakeCurrent  write FOnMakeCurrent;
    ...
    property Options: TOpenGLPanelOptions read FOptions write SetOptions;
  end;
...
procedure TCustomOpenGLPanel.SetOptions(AValue: TOpenGLPanelOptions);
var
...
function TCustomOpenGLPanel.IsOpenGLRenderAllowed: boolean;
begin

...
////////////////////////////////////////////////////////////////////////////////
  ...
  private
    FHasSeeked: boolean;
  public
    function Stat(out statstg: TStatStg; {$IFDEF FPC311} grfStatFlag: DWORD
      {$ELSE} grfStatFlag: LongInt {$ENDIF} ): HResult; override; stdcall;
...
function TFixedStreamAdapter.Stat(out statstg: TStatStg;{$IFDEF FPC311} grfStatFlag: DWORD
  {$ELSE} grfStatFlag: LongInt {$ENDIF}): HResult;
begin

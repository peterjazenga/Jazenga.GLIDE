...
type
  ...
  protected
    ...
    procedure FillLine(Dst: PColor32; DstX, DstY, Length: Integer; AlphaValues: PColor32); virtual;
    procedure FillLineWebSafe(Dst: PColor32; DstX, DstY, Length: Integer; AlphaValues: PColor32); virtual;
  public
  ...
  protected
    procedure FillLine(Dst: PColor32; DstX, DstY, Length: Integer; AlphaValues: PColor32); override;
    procedure FillLineWebSafe(Dst: PColor32; DstX, DstY, Length: Integer; AlphaValues: PColor32); override;
  public
  ...
  protected
    function GetFillLine: TFillLineEvent; override;
    procedure FillLineWebSafe(Dst: PColor32; DstX, DstY, Length: Integer; AlphaValues: PColor32);
  public
    property WebSafe: Boolean read FWebSafe write FWebSafe;
  end;
...
begin
  ...
  self.SetInitialBounds(0,0,210,210);  // ct9999 for CodeTyphon studio
end;
...
begin
  ...
  self.SetInitialBounds(0,0,240,210);  // ct9999 for CodeTyphon studio
end;

...
type
  ...
  var AxisText: String; var AxisFont: TFont; var EventHandled: boolean);
...
begin
   ...
   if Colorbox.Checked then
      begin
      if (value=0)
         then AxisFont.Color:=clBlack
         else
            if (Value<0)
               then AxisFont.Color:=clRed
               else AxisFont.Color:=clBlue;
      end;

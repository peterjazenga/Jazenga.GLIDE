...
type
  ...
  public
    ...
    procedure DrawGlyph(ARect: TRect; AGlyphDesign: TGlyphDesign; AState: TItemState = eisEnabled);
...
function InRangeCO(const AValue, AMin, AMax: Integer): Boolean; inline;
...
begin
  ...
  r := 341*(r + g + b) shr 10;
  Result := (r shl 16) or (r shl 8) or r;
end;

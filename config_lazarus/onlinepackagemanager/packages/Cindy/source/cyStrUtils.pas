...
// *** SubString functions *** //
  ...
  { Francais: Definition d' une sous-chaine, appele element:
    Une chaine de caracteres peut etre definit de plusieurs elements separes par un caractere definit.
    On admet que si une string = '', celle-ci contient un seul element appele subString de valeur ''.
    Donc, le nombre d' elements ne peut etre inferieur a 1.
    Le 1er element dans une string a pour Index 1, le second a pour Index 2 etc ...

    Exemple (lorsque ';' est le separateurs des elements) :
    Si Str = ''                 on a 1 element vide
    Si Str = 'xxx'              on a 1 element de valeur 'xxx'
    Si Str = ';'                on a 2 elements vide
    Si Str = 'xxx;'             on a 2 elements  de valeur 'xxx' et ''
    Si Str = ';xxx'             on a 2 elements  de valeur '' et 'xxx'
    Si Str = 'xxx;yyy'          on a 2 elements  de valeur 'xxx' et 'yyy'
  }

  function SubString_Count(Str: String; Separator: Char): Integer;
  // English: Retrieve the number of substring
  // Francais: La fonction renvoie le nombre d' elements dans Str
  ...
  // Francais: Renvoie la position du 1er caractere de l' element d' indexe SubStringIndex

  function SubString_Get(Str: String; Separator: Char; SubStringIndex: Word): String;
  // English: Retrieve substring element by index
  // Francais: Renvoie l' element d' indexe SubStringIndex
  ...
  // Francais: Renvoie le nombre de caracteres de l' element d' indexe SubStringIndex
  ...
  // Francais: Ajoute un element a la fin de la string. Pour le 1er element, utilisez Str := 'exemple'
  ...
  // Francais: Insere un element a la position SubStringIndex
  ...
  // Francais: Modifie/initialise l' element definit par SubStringIndex.
  ...
  // Francais: Elimine l' element a l' index SubStringIndex
  ...
  // Francais: Renvoie la position de l' element specifie
  ...
  // Francais: Renvoie la position d' un element par rapport a un autre en ce deplaceant de "MoveBy" elements.
  // Si on se retrouve a la fin, on revient au debut et vice versa.
  ...
  // Francais: comme la fonction anterieure, si ce n' est que l' element est cette fois definit par sa valeur
...
// *** String functions *** //
  ...
  // Francais: Renvoie le caractere a la position "Position"
  ...
  // Francais: Renvoie les types de caracteres specifie avec CharCategories (nombres, lettres etc ...)
  {$ENDIF}
  ...
  // Francais: Renvoie une string qui peut etre convertie en type Word si le resultat de la fonction n' est pas vide
  ...
  // Francais: Renvoie une string qui peut etre convertie en type Integer si le resultat de la fonction n' est pas vide

  function String_ToInt(Str: String): Integer;
  // English: Always convert a string to an integer, returns 0 if not valid integer
  // Francais: Converti une String en Integer si possible, sinon renvoie 0

  function String_Uppercase(Str: String; Options: TWordsOptions) : String;
  // English: Uppercase string by Options
  // Francais: Renvoie la string en majuscule selon Options (1ere lettre de string, 1ere lettre de chaque mot ou toute la string)

  function String_Lowercase(Str: String; Options: TWordsOptions) : String;
  // English: Lowercase string by Options
  // Francais: Renvoie la string en minuscule selon Options (1ere lettre de string, 1ere lettre de chaque mot ou toute la string)

  function String_Reverse(Str: String): String;
  // English: Revert a string, String_Reverse('Hello ') returns 'olleH'
  // Francais: Renvoie l' ordre des carateres inverse de la string
...
// Francais: Renvoie la position d' une substring depuis une certaine position
  ...
  // Francais: Renvoie la position d' une substring selon son ocurrence
  ...
  // Francais: Renvoie la copie d' une string selon la position du 1er et dernier caractere
  ...
  // Francais: Renvoie la copie d' une string tant qu' elle ne trouve pas UntilFind
  ...
  // Francais: Renvoie les caracteres d' uyne string entre 2 substrings.
  ...
  // Francais: Elimine les caracteres d' une string entre la position du 1er et dernier caractere specifie
  ...
  // Francais: Renvoie la string apres avoir retire toute SubString specifiee avec delStr
  ...
  // Francais: Permet de retirer un caractere tant que la string commence ou fini para celui-ci.
  ...
  // Francais: Permet d' ajouter un caractere au debut ou/et a la fin d' une string jusqu' a ce que la string se retrouve de la taille de "ReturnLength" caracteres
  ...
  // Francais: Permet d' ajouter un caractere au debut ou a la fin d' une string jusqu' a ce que la string se retrouve de la taille de "ReturnLength" caracteres

  function String_End(Str: String; Cars: Word): String;
  // English: Get last string caracters
  // Francais: Renvoie les derniers caracteres d' une string
  ...
  // Francais: Fonction identique a StringReplace.
  // Permet cependant de toujours remplacer en recherchant depuis le debut de la string. Utile lorsque New est contenu par OldStr

  function String_SubstCar(Str: String; Old, New: Char): String;
  // English: Replace a caracter by another
  // Francais: Remplace un caractere par un autre dans une string
  ...
  // Francais: Renvoie le nombre d' occurences d' une SubString
  ...
  // Francais: Compte le nombre de caracteres identiques a la meme position entre 2 strings

  function String_IsNumbers(Str: String) : Boolean;
  // English: Returns True if the string contains only numeric caracters
  // Francais: Permet de savoir si la string ne possede que des caracteres de type chiffre.
  ...
  // Francais: Recherche une chaine de caracteres a l' interieur d' une autre avec une tolerence de diferences
...
begin
  ...
  then begin
    ...
    while FoundPos > 0 do
    begin
      // Passar o que esta antes da posicao + New:
      Result := Result + Copy(Str, 1, FoundPos - 1) + New;

      // Remover ate a posicao de Ant, remover tambem Ant :

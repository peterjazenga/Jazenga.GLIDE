...
type
  ...
  private
    ...
    procedure CNDrawItem(var Message: TLMDrawItems); message LM_DRAWITEM;
...
procedure TcyBaseButton.CNDrawItem(var Message: TLMDrawItems);   
var
...
begin
  ...
  FCanvas.Handle := DrawItemStruct._HDC;    
...
begin
  ...
  DrawStyle := cyGraphics.DrawTextFormatFlags(0, aAlignment, aTextLayout, WordWrap);   

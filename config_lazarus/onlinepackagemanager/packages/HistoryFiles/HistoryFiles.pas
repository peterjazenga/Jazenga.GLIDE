...
{$IFDEF FPC} //Lazarus
  uses IniFiles, Menus, SysUtils, Classes, Dialogs, Forms, LResources,
    LazarusPackageIntf, Graphics, FileUtil, LazFileUtils;
{$ELSE}
  {$IfNDef LINUX} //Delphi
    uses IniFiles,Menus,SysUtils,Classes,Dialogs,Forms,Graphics;
  {$ELSE} //Kylix
    uses IniFiles,QMenus,SysUtils,Classes,QDialogs,QForms,QGraphics;
  {$EndIf}
{$ENDIF}

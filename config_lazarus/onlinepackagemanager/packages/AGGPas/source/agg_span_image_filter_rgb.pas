...
{ GENERATE }
function span_image_filter_rgb_nn.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
...
{ GENERATE }
function span_image_filter_rgb_bilinear.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
 fg : array[0..2 ] of unsigned;
...
{ GENERATE }
function span_image_filter_rgb_2x2.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
 fg : array[0..2 ] of unsigned;
...
{ GENERATE }
function span_image_filter_rgb.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
 fg : array[0..2 ] of int;

...
type
  ...
  vcgen_smooth_poly1 = object(vertex_source)
    ...
    m_ctrl1_x, m_ctrl1_y, m_ctrl2_x, m_ctrl2_y: double;
...
{ SMOOTH_VALUE_ }
procedure vcgen_smooth_poly1.smooth_value_(v: double);
begin
...
{ _SMOOTH_VALUE }
function vcgen_smooth_poly1._smooth_value: double;
begin
...
{ ADD_VERTEX }
procedure vcgen_smooth_poly1.add_vertex(x, y: double; cmd: unsigned);
var
  vd: vertex_dist;
...
{ REWIND }
procedure vcgen_smooth_poly1.rewind(path_id: unsigned);
begin
...
{ VERTEX }
function vcgen_smooth_poly1.vertex(x, y: double_ptr): unsigned;
var
  cmd: unsigned;
...
{ CALCULATE }
procedure vcgen_smooth_poly1.calculate(v0, v1, v2, v3: vertex_dist_ptr);
var

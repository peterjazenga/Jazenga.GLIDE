...
{ SOURCE_IMAGE_ }
procedure span_pattern_filter_gray_nn.source_image_(src : rendering_buffer_ptr );
begin
...
{ GENERATE }
function span_pattern_filter_gray_nn.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
 span : aggclr_ptr;
...
{ SOURCE_IMAGE_ }
procedure span_pattern_filter_gray_bilinear.source_image_(src : rendering_buffer_ptr );
begin
 inherited source_image_(src );
...
{ GENERATE }
function span_pattern_filter_gray_bilinear.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
...
{ SOURCE_IMAGE_ }
procedure span_pattern_filter_gray_2x2.source_image_(src : rendering_buffer_ptr );
begin
 inherited source_image_(src );
...
{ GENERATE }
function span_pattern_filter_gray_2x2.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
 fg ,x1 ,x2 ,y1 ,y2 : unsigned;
...
{ SOURCE_IMAGE_ }
procedure span_pattern_filter_gray.source_image_(src : rendering_buffer_ptr );
begin
 inherited source_image_(src );
...
{ GENERATE }
function span_pattern_filter_gray.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var

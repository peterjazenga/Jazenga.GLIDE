...
type
  ...
  sbool_functor = object
    cover_shift, cover_size, cover_mask, cover_full: unsigned;
...
{ GLOBAL PROCEDURES }
procedure sbool_subtract_shapes_aa(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_xor_shapes_abs_diff_aa(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_xor_shapes_saddle_aa(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_xor_shapes_aa(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_intersect_shapes_aa(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_unite_shapes_aa(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_combine_shapes_aa(op: sbool_op_e; sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_subtract_shapes_bin(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_xor_shapes_bin(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_intersect_shapes_bin(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_unite_shapes_bin(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

procedure sbool_combine_shapes_bin(op: sbool_op_e; sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);

implementation

constructor sbool_functor.Construct1(f1: sbool_functor1; CoverShift: unsigned = agg_basics.cover_shift);
begin
...
{ CONSTRUCT2 }
constructor sbool_functor.Construct2(f2: sbool_functor2; CoverShift: unsigned = agg_basics.cover_shift);
begin
  cover_shift := CoverShift;
  cover_size := 1 shl cover_shift;
  cover_mask := cover_size - 1;
...
begin
  ...
  case unsigned(span1^.len < 0) or (unsigned(span2^.len < 0) shl 1) of
    ...
    begin
      ...
      repeat
        cover :=
          this^.cover_mask * this^.cover_mask - (this^.cover_mask - covers1^) * (this^.cover_mask - covers2^);
    ...
    begin
      ...
      if span1^.covers^ = this^.cover_full then
        ...
        repeat
          cover :=
            this^.cover_mask * this^.cover_mask - (this^.cover_mask - span1^.covers^) * (this^.cover_mask - covers2^);
    ...
    begin
      ...
      if span2^.covers^ = this^.cover_full then
        ...
        repeat
          cover :=
            this^.cover_mask * this^.cover_mask - (this^.cover_mask - covers1^) * (this^.cover_mask - span2^.covers^);
    ...
    begin
      cover :=
        this^.cover_mask * this^.cover_mask - (this^.cover_mask - span1^.covers^) * (this^.cover_mask - span2^.covers^);
...
procedure sbool_add_spans_and_render(sl1, sl: scanline_ptr; ren: renderer_scanline_ptr;
...
procedure sbool_unite_scanlines(sl1, sl2, sl: scanline_ptr;
  add_span1, add_span2, combine_spans: sbool_functor_ptr);
const
  invalid_b = $FFFFFFF;
...
procedure sbool_unite_shapes(sg1, sg2: rasterizer_scanline_ptr; sl1, sl2, sl: scanline_ptr;
  ren: renderer_scanline_ptr; add_span1, add_span2, combine_spans: sbool_functor_ptr);
var
  flag1, flag2: boolean;
...
// two spans without Anti-Aliasing, the second preserves the AA
// information, but works slower
procedure sbool_intersect_scanlines(sl1, sl2, sl: scanline_ptr; combine_spans: sbool_functor_ptr);
var
  num1, num2: unsigned;
  span1, span2: span_ptr;
...
procedure sbool_intersect_shapes(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr; combine_spans: sbool_functor_ptr);
var
  r1, r2, ir: rect;
...
procedure sbool_subtract_shapes(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr;
  add_span1, combine_spans: sbool_functor_ptr);
var
  r1: rect;
...
procedure sbool_subtract_shapes_aa(sg1, sg2: rasterizer_scanline_ptr;
  sl1, sl2, sl: scanline_ptr; ren: renderer_scanline_ptr);
var
  add_functor, combine_functor: sbool_functor;
...
begin
  ...
  sbool_subtract_shapes(
    sg1, sg2, sl1, sl2, sl, ren, @add_functor, @combine_functor);
...
begin
  ...
  Pointer(combine_functor.formula) := @sbool_xor_formula_abs_diff;

  sbool_unite_shapes(
    sg1, sg2, sl1, sl2, sl, ren, @add_functor, @add_functor, @combine_functor);
...
begin
  ...
  Pointer(combine_functor.formula) := @sbool_xor_formula_saddle;
...
begin
  ...
  sbool_intersect_shapes(
    sg1, sg2, sl1, sl2, sl, ren, @combine_functor);

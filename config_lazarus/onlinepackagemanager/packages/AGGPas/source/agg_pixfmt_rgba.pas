...
begin
  ...
  Pointer(pixf.pixel_premultiply) := @order32_pixel_premultiply;
  Pointer(pixf.pixel_demultiply)  := @order32_pixel_demultiply;
...
begin
  ...
  begin
    ...
    int8u_ptr(ptrcomp(p) + this^.m_order.R)^ := int8u(((int8u_ptr(ptrcomp(p) + this^.m_order.R)^ * alpha + 255) shr 8) +
      ((sr * cover + 255) shr 8));
    int8u_ptr(ptrcomp(p) + this^.m_order.G)^ := int8u(((int8u_ptr(ptrcomp(p) + this^.m_order.G)^ * alpha + 255) shr 8) +
      ((sg * cover + 255) shr 8));
    int8u_ptr(ptrcomp(p) + this^.m_order.B)^ := int8u(((int8u_ptr(ptrcomp(p) + this^.m_order.B)^ * alpha + 255) shr 8) +
      ((sb * cover + 255) shr 8));
    int8u_ptr(ptrcomp(p) + this^.m_order.A)^ := int8u(((int8u_ptr(ptrcomp(p) + this^.m_order.A)^ * alpha + 255) shr 8) +
      ((sa * cover + 255) shr 8));
...
begin
  ...
  begin
    ...
    int8u_ptr(ptrcomp(p) + this^.m_order.R)^ :=
      int8u(((int8u_ptr(ptrcomp(p) + this^.m_order.R)^ * alpha + 255) shr 8) +
      ((((sr * da + base_mask) shr base_shift) * cover + 255) shr 8));

    int8u_ptr(ptrcomp(p) + this^.m_order.G)^ :=
      int8u(((int8u_ptr(ptrcomp(p) + this^.m_order.G)^ * alpha + 255) shr 8) +
      ((((sg * da + base_mask) shr base_shift) * cover + 255) shr 8));

    int8u_ptr(ptrcomp(p) + this^.m_order.B)^ :=
      int8u(((int8u_ptr(ptrcomp(p) + this^.m_order.B)^ * alpha + 255) shr 8) +
      ((((sb * da + base_mask) shr base_shift) * cover + 255) shr 8));

    int8u_ptr(ptrcomp(p) + this^.m_order.A)^ :=
      int8u(((int8u_ptr(ptrcomp(p) + this^.m_order.A)^ * alpha + 255) shr 8) +
      ((((sa * da + base_mask) shr base_shift) * cover + 255) shr 8));
...
begin
  ...
  int8u_ptr(ptrcomp(p) + this^.m_order.A)^ :=
    int8u(sa + int8u_ptr(ptrcomp(p) + this^.m_order.A)^ - ((sa * int8u_ptr(ptrcomp(p) + this^.m_order.A)^ + base_mask div 2) shr
    (base_shift - 1)));
...
begin
  ...
  begin
    ...
    int8u_ptr(ptrcomp(p) + this^.m_order.R)^ :=
      int8u(dr + shr_int32(int8u_ptr(ptrcomp(p) + this^.m_order.R)^ * s1a + base_mask, base_shift));

    int8u_ptr(ptrcomp(p) + this^.m_order.G)^ :=
      int8u(dg + shr_int32(int8u_ptr(ptrcomp(p) + this^.m_order.G)^ * s1a + base_mask, base_shift));

    int8u_ptr(ptrcomp(p) + this^.m_order.B)^ :=
      int8u(db + shr_int32(int8u_ptr(ptrcomp(p) + this^.m_order.B)^ * s1a + base_mask, base_shift));

    int8u_ptr(ptrcomp(p) + this^.m_order.A)^ :=
      int8u(sa + da - shr_int32(sa * da + base_mask, base_shift));

...
{ QUAD_TO_QUAD }
procedure trans_bilinear.quad_to_quad(src, dst: double_ptr);
var
  left: double_44;
  right: double_42;
...
{ RECT_TO_QUAD }
procedure trans_bilinear.rect_to_quad(x1, y1, x2, y2: double; quad: double_ptr);
var
  src: double_8;
...
{ QUAD_TO_RECT }
procedure trans_bilinear.quad_to_rect(quad: double_ptr; x1, y1, x2, y2: double);
var
  dst: double_8;
...
{ IS_VALID }
function trans_bilinear.is_valid: boolean;
begin
  Result := m_valid;
...
{ BEGIN_ }
function trans_bilinear.begin_(x, y, step: double): iterator_x;
begin

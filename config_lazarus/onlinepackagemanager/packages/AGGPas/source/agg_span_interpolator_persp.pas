...
type
  span_interpolator_persp_exact = object(span_interpolator)
    m_trans_dir, m_trans_inv: trans_perspective23;
    m_iterator: agg_trans_perspective.iterator_x23;
    m_scale_x, m_scale_y: dda2_line_interpolator;
  ...
  span_interpolator_persp_lerp = object(span_interpolator)
    ...
    m_coord_x, m_coord_y, m_scale_x, m_scale_y: dda2_line_interpolator;
...
{ QUAD_TO_QUAD }
procedure span_interpolator_persp_exact.quad_to_quad(src, dst: double_ptr);
begin
...
{ RECT_TO_QUAD }
procedure span_interpolator_persp_exact.rect_to_quad(x1, y1, x2, y2: double; quad: double_ptr);
var
...
{ QUAD_TO_RECT }
procedure span_interpolator_persp_exact.quad_to_rect(quad: double_ptr; x1, y1, x2, y2: double);
var
...
{ IS_VALID }
function span_interpolator_persp_exact.is_valid: boolean;
begin
...
{ BEGIN_ }
procedure span_interpolator_persp_exact.begin_(x, y: double; len: unsigned);
var
...
{ RESYNCHRONIZE }
procedure span_interpolator_persp_exact.resynchronize(xe, ye: double; len: unsigned);
var
  sx1, sy1, sx2, sy2: int;
...
{ COORDINATES }
procedure span_interpolator_persp_exact.coordinates(x, y: int_ptr);
begin
...
{ LOCAL_SCALE }
procedure span_interpolator_persp_exact.local_scale(x, y: int_ptr);
begin
  x^ := m_scale_x._y;
  y^ := m_scale_y._y;
...
{ TRANSFORM }
procedure span_interpolator_persp_exact.transform(x, y: double_ptr);
begin
...
{ QUAD_TO_QUAD }
procedure span_interpolator_persp_lerp.quad_to_quad(src, dst: double_ptr);
begin
  m_trans_dir.quad_to_quad(src, dst);
  m_trans_inv.quad_to_quad(dst, src);
...
{ RECT_TO_QUAD }
procedure span_interpolator_persp_lerp.rect_to_quad(x1, y1, x2, y2: double; quad: double_ptr);
var
  src: array[0..7] of double;
...
{ QUAD_TO_RECT }
procedure span_interpolator_persp_lerp.quad_to_rect(quad: double_ptr; x1, y1, x2, y2: double);
var
  dst: array[0..7] of double;
...
{ IS_VALID }
function span_interpolator_persp_lerp.is_valid: boolean;
begin
  Result := m_trans_dir.is_valid;
...
{ BEGIN_ }
procedure span_interpolator_persp_lerp.begin_(x, y: double; len: unsigned);
var
  xt, yt, dx, dy, delta: double;
...
{ RESYNCHRONIZE }
procedure span_interpolator_persp_lerp.resynchronize(xe, ye: double; len: unsigned);
var
  x1, y1, sx1, sy1, x2, y2, sx2, sy2: int;
...
{ COORDINATES }
procedure span_interpolator_persp_lerp.coordinates(x, y: int_ptr);
begin
  x^ := m_coord_x._y;
  y^ := m_coord_y._y;
...
{ LOCAL_SCALE }
procedure span_interpolator_persp_lerp.local_scale(x, y: int_ptr);
begin
  x^ := m_scale_x._y;
  y^ := m_scale_y._y;
...
{ TRANSFORM }
procedure span_interpolator_persp_lerp.transform(x, y: double_ptr);
begin
  m_trans_dir.transform(@m_trans_dir, x, y);

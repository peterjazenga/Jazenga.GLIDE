...
{ SOURCE_IMAGE_ }
procedure span_pattern_resample_rgb_affine.source_image_(src: rendering_buffer_ptr);
begin
...
{ GENERATE }
function span_pattern_resample_rgb_affine.generate(x, y: int; len: unsigned): aggclr_ptr;
var
 span : aggclr_ptr;
...
{ SOURCE_IMAGE_ }
procedure span_pattern_resample_rgb.source_image_(src: rendering_buffer_ptr);
begin
 inherited source_image_(src );
...
{ GENERATE }
function span_pattern_resample_rgb.generate(x, y: int; len: unsigned): aggclr_ptr;
var
 span : aggclr_ptr;
 intr : span_interpolator_ptr;

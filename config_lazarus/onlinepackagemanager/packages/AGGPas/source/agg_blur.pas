...
type
  ...
  private
    m_sum1, m_sum2, m_buf: pod_vector;
  public
    constructor Construct;
    destructor Destruct;
...
type
  ...
  gauss_calculator = object
    ...
    procedure calc(b1, b2, b3, b4: double; c1, c2, c3, c4: gauss_calculator_ptr);
...
{ CALC }
procedure gauss_calculator.calc(b1, b2, b3, b4: double; c1, c2, c3, c4: gauss_calculator_ptr);
begin
...
var
  x, y, xp, i, stack_ptr, stack_start, w, h, wm, div_, div_sum, mul_sum, shr_sum, max_val: unsigned;
...
begin
  ...
  if (max_val <= 255) and (radius < 255) then
  begin
...
var
  ...
  x, y, xp, yp, i, pix, stack_pix, sum, sum_in, sum_out, stack_ptr, stack_start, w, h, wm, hm, div_, mul_sum, shr_sum: unsigned;
...
var
  ...
  x, y, xp, yp, i, stack_ptr, stack_start, sum_r, sum_g, sum_b, sum_in_r, sum_in_g, sum_in_b, sum_out_r, sum_out_g, sum_out_b,
...
var
  ...
  x, y, xp, yp, i, stack_ptr, stack_start, sum_r, sum_g, sum_b, sum_a, sum_in_r, sum_in_g, sum_in_b, sum_in_a,
  sum_out_r, sum_out_g, sum_out_b, sum_out_a, w, h, wm, hm, div_, mul_sum, shr_sum: unsigned;

    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if agg_getmem(pointer(spanf), length * sizeof(single)) and agg_getmem(pointer(spang),
            (length + 1) * sizeof(single)) and agg_getmem(pointer(spanr), length * sizeof(single)) and

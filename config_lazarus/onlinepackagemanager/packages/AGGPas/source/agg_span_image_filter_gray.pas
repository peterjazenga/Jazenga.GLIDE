...
{ GENERATE }
function span_image_filter_gray_nn.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
 maxx ,maxy : int;
...
{ GENERATE }
function span_image_filter_gray_bilinear.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
...
{ GENERATE }
function span_image_filter_gray_2x2.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var
 fg ,src_alpha ,weight : unsigned;
...
{ GENERATE }
function span_image_filter_gray.generate(x ,y : int; len : unsigned ) : aggclr_ptr;
var

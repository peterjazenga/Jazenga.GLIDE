...
type
  rounded_rect = object(vertex_source)
    m_x1, m_y1, m_x2, m_y2, m_rx1, m_ry1, m_rx2, m_ry2, m_rx3, m_ry3, m_rx4, m_ry4: double;
...
{ RECT }
procedure rounded_rect.rect(x1, y1, x2, y2: double);
begin
  m_x1 := x1;
  m_y1 := y1;
  m_x2 := x2;
...
procedure rounded_rect.approximation_scale_(s: double);
begin
...
function rounded_rect._approximation_scale: double;
begin
...
{ REWIND }
procedure rounded_rect.rewind(path_id: unsigned);
begin
  m_status := 0;
...
{ VERTEX }
function rounded_rect.vertex(x, y: double_ptr): unsigned;
var
  cmd: unsigned;

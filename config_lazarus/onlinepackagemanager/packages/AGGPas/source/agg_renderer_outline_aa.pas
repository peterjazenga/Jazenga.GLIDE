...
{ DIST }
function distance_interpolator0.dist : int;
begin
 result:=m_dist;
...
{ DX }
function distance_interpolator0.dx : int;
begin
 result:=m_dx;
...
{ DY }
function distance_interpolator0.dy : int;
begin
 result:=m_dy;
...
{ DIST }
function distance_interpolator1.dist : int;
begin
 result:=m_dist;
...
{ DX }
function distance_interpolator1.dx : int;
begin
 result:=m_dx;
...
{ DY }
function distance_interpolator1.dy : int;
begin
 result:=m_dy;
...
{ DIST }
function distance_interpolator2.dist : int;
begin
 result:=m_dist;
...
{ DIST_START }
function distance_interpolator2.dist_start : int;
begin
 result:=m_dist_start;
...
{ DIST_END }
function distance_interpolator2.dist_end : int;
begin
 result:=m_dist_start;
...
{ DX }
function distance_interpolator2.dx : int;
begin
 result:=m_dx;
...
{ DY }
function distance_interpolator2.dy : int;
begin
 result:=m_dy;
...
{ DX_START }
function distance_interpolator2.dx_start : int;
begin
 result:=m_dx_start;
...
{ DY_START }
function distance_interpolator2.dy_start : int;
begin
 result:=m_dy_start;
...
{ DX_END }
function distance_interpolator2.dx_end : int;
begin
 result:=m_dx_start;
...
{ DY_END }
function distance_interpolator2.dy_end : int;
begin
 result:=m_dy_start;
...
{ DIST }
function distance_interpolator3.dist : int;
begin
 result:=m_dist;
...
{ DIST_START }
function distance_interpolator3.dist_start : int;
begin
 result:=m_dist_start;
...
{ DIST_END }
function distance_interpolator3.dist_end : int;
begin
 result:=m_dist_end;
...
{ DX }
function distance_interpolator3.dx : int;
begin
 result:=m_dx;
...
{ DY }
function distance_interpolator3.dy : int;
begin
 result:=m_dy;
...
{ DX_START }
function distance_interpolator3.dx_start : int;
begin
 result:=m_dx_start;
...
{ DY_START }
function distance_interpolator3.dy_start : int;
begin
 result:=m_dy_start;
...
{ DX_END }
function distance_interpolator3.dx_end : int;
begin
 result:=m_dx_end;
...
{ DY_END }
function distance_interpolator3.dy_end : int;
begin
 result:=m_dy_end;
...
{ CONSTRUCT }
constructor line_interpolator_aa_base.Construct(ren : renderer_outline_aa_ptr; lp : line_parameters_ptr );
var
...
{ STEP_HOR_BASE }
function line_interpolator_aa_base.step_hor_base(di : distance_interpolator_ptr ) : int;
begin
 m_li.plus_operator;
...
{ STEP_VER_BASE }
function line_interpolator_aa_base.step_ver_base(di : distance_interpolator_ptr ) : int;
begin
 m_li.plus_operator;
...
{ VERTICAL }
function line_interpolator_aa_base.vertical : boolean;
begin
...
{ WIDTH }
function line_interpolator_aa_base.width : int;
begin
 result:=m_width;
...
{ COUNT }
function line_interpolator_aa_base.count : int;
begin
 result:=m_count;
...
{ CONSTRUCT }
constructor line_interpolator_aa0.Construct(ren : renderer_outline_aa_ptr; lp : line_parameters_ptr );
begin
...
{ STEP_HOR }
function line_interpolator_aa0.step_hor : boolean;
var
 dist ,dy ,s1 : int;
...
{ STEP_VER }
function line_interpolator_aa0.step_ver : boolean;
var
 dist ,dx ,s1 : int;
...
{ CONSTRUCT }
constructor line_interpolator_aa1.Construct(ren : renderer_outline_aa_ptr; lp : line_parameters_ptr; sx ,sy : int );
var
...
{ STEP_HOR }
function line_interpolator_aa1.step_hor : boolean;
var
...
{ STEP_VER }
function line_interpolator_aa1.step_ver : boolean;
var
...
{ CONSTRUCT }
constructor line_interpolator_aa2.Construct(ren : renderer_outline_aa_ptr; lp : line_parameters_ptr; ex ,ey : int );
begin
 inherited Construct(ren ,lp );
...
{ STEP_HOR }
function line_interpolator_aa2.step_hor : boolean;
var
...
{ STEP_VER }
function line_interpolator_aa2.step_ver : boolean;
var
...
{ CONSTRUCT }
constructor line_interpolator_aa3.Construct(ren : renderer_outline_aa_ptr; lp : line_parameters_ptr; sx ,sy ,ex ,ey : int );
var
 dist1_start ,dist2_start ,npix ,dx ,dy : int;
...
{ STEP_HOR }
function line_interpolator_aa3.step_hor : boolean;
var
...
{ STEP_VER }
function line_interpolator_aa3.step_ver : boolean;
var
...
{ MIN_WIDTH_ }
procedure line_profile_aa.min_width_(w : double );
begin
 m_min_width:=w;
...
{ SMOOTHER_WIDTH_ }
procedure line_profile_aa.smoother_width_(w : double );
begin
 m_smoother_width:=w;
...
{ GAMMA_ }
procedure line_profile_aa.gamma_(gamma_function : vertex_source_ptr );
var
 i : int;
...
{ WIDTH_ }
procedure line_profile_aa.width_(w : double );
var
 s : double;
...
{ _PROFILE_SIZE }
function line_profile_aa._profile_size : unsigned;
begin
 result:=m_size;
...
{ _SUBPIXEL_WIDTH }
function line_profile_aa._subpixel_width : int;
begin
...
{ _MIN_WIDTH }
function line_profile_aa._min_width : double;
begin
 result:=m_min_width;
...
{ _SMOOTHER_WIDTH }
function line_profile_aa._smoother_width : double;
begin
...
{ VALUE }
function line_profile_aa.value(dist : int ) : int8u;
begin
 result:=
  int8u_ptr(
...
{ PROFILE }
function line_profile_aa.profile(w : double ) : int8u_ptr;
var
 size : unsigned;
...
{ SET_ }
procedure line_profile_aa.set_(center_width ,smoother_width : double );
var
...
{ CONSTRUCT }
constructor renderer_outline_aa.Construct(ren : renderer_base_ptr; prof : line_profile_aa_ptr );
begin
 m_ren    :=ren;
 m_profile:=prof;
...
{ COLOR_ }
procedure renderer_outline_aa.color_(c : aggclr_ptr );
begin
 m_color:=c^;
...
{ _COLOR }
function renderer_outline_aa._color : aggclr_ptr;
begin
 result:=@m_color;
...
{ PROFILE_ }
procedure renderer_outline_aa.profile_(prof : line_profile_aa_ptr );
begin
 m_profile:=prof;
...
{ _PROFILE }
function renderer_outline_aa._profile : line_profile_aa_ptr;
begin
 result:=m_profile;
...
{ SUBPIXEL_WIDTH }
function renderer_outline_aa.subpixel_width : int;
begin
...
{ COVER }
function renderer_outline_aa.cover(d : int ) : int8u;
begin
...
{ BLEND_SOLID_HSPAN }
procedure renderer_outline_aa.blend_solid_hspan(x ,y : int; len : unsigned; covers : int8u_ptr );
begin
...
{ BLEND_SOLID_VSPAN }
procedure renderer_outline_aa.blend_solid_vspan(x ,y : int; len : unsigned; covers : int8u_ptr );
begin
...
{ ACCURATE_JOIN_ONLY }
function renderer_outline_aa.accurate_join_only : boolean;
begin
 result:=false;
...
{ SEMIDOT_HLINE }
procedure renderer_outline_aa.semidot_hline(cmp : cmp_function; xc1 ,yc1 ,xc2 ,yc2 ,x1 ,y1 ,x2 : int );
var
...
{ SEMIDOT }
procedure renderer_outline_aa.semidot(cmp : cmp_function; xc1 ,yc1 ,xc2 ,yc2 : int );
var
...
{ LINE0 }
procedure renderer_outline_aa.line0(lp : line_parameters_ptr );
var
...
{ LINE1 }
procedure renderer_outline_aa.line1(lp : line_parameters_ptr; sx ,sy : int );
var
...
{ LINE2 }
procedure renderer_outline_aa.line2(lp : line_parameters_ptr; ex ,ey : int );
var
...
{ LINE3 }
procedure renderer_outline_aa.line3(lp : line_parameters_ptr; sx ,sy ,ex ,ey : int );
var

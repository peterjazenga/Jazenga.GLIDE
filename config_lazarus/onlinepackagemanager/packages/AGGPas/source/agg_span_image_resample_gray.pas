...
{ GENERATE }
function span_image_resample_gray_affine.generate(x, y: int; len: unsigned): aggclr_ptr;
var
  fg, src_alpha, diameter, filter_size, radius_x, radius_y, maxx, maxy, y_lr, y_hr, total_weight, x_lr_ini, x_hr_ini,
  weight_y, x_lr, x_hr, weight: int;
...
{ GENERATE }
function span_image_resample_gray.generate(x, y: int; len: unsigned): aggclr_ptr;
var
  span: aggclr_ptr;

  fg, src_alpha, diameter, filter_size, rx, ry, rx_inv, ry_inv, radius_x, radius_y, maxx, maxy, y_lr, y_hr, total_weight,

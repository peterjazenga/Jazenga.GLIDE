...
{ INTERPOLATION_STEP_ }
procedure vcgen_bspline.interpolation_step_(v : double );
begin
...
{ _INTERPOLATION_STEP }
function vcgen_bspline._interpolation_step : double;
begin
...
{ ADD_VERTEX }
procedure vcgen_bspline.add_vertex(x ,y : double; cmd : unsigned );
var
 pt : point_type;
...
{ REWIND }
procedure vcgen_bspline.rewind(path_id : unsigned );
var
 i : unsigned;
 x : double;
...
{ VERTEX }
function vcgen_bspline.vertex(x ,y : double_ptr ) : unsigned;
var
 cmd : unsigned;

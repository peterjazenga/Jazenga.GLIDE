...
{ SET_PATH_STR }
procedure path_tokenizer.set_path_str(str : char_ptr );
begin
 m_path        :=str;
 m_last_command:=#0;
 m_last_number :=0.0;
...
{ LAST_COMMAND }
function path_tokenizer.last_command : char;
begin
...
{ LAST_NUMBER }
function path_tokenizer.last_number : double;
begin
...
{ INIT_CHAR_MASK }
procedure path_tokenizer.init_char_mask(mask ,char_set : char_ptr );
var
 c : unsigned;
...
{ CONTAINS_ }
function path_tokenizer.contains_   (mask : char_ptr; c : unsigned ) : boolean;
begin
 result:=
...
{ IS_COMMAND }
function path_tokenizer.is_command  (c : unsigned ) : boolean;
begin
...
{ IS_NUMERIC }
function path_tokenizer.is_numeric  (c : unsigned ) : boolean;
begin
...
{ IS_SEPARATOR }
function path_tokenizer.is_separator(c : unsigned ) : boolean;
begin
...
{ PARSE_NUMBER }
function path_tokenizer.parse_number : boolean;
var

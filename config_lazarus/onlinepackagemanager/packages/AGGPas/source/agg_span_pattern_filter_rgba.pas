...
{ CONSTRUCT }
constructor span_pattern_filter_rgba_nn.Construct(alloc: span_allocator_ptr; src: rendering_buffer_ptr;
...
{ SOURCE_IMAGE_ }
procedure span_pattern_filter_rgba_nn.source_image_(src: rendering_buffer_ptr);
begin
...
{ GENERATE }
function span_pattern_filter_rgba_nn.generate(x, y: int; len: unsigned): aggclr_ptr;
var
  fg_ptr: int8u_ptr;
...
{ CONSTRUCT }
constructor span_pattern_filter_rgba_bilinear.Construct(alloc: span_allocator_ptr;
  src: rendering_buffer_ptr; interpolator: span_interpolator_ptr; WX, WY: wrap_mode_ptr;
  order: order_type);
var
  rgba: aggclr;
...
{ SOURCE_IMAGE_ }
procedure span_pattern_filter_rgba_bilinear.source_image_(src: rendering_buffer_ptr);
begin
  inherited source_image_(src);
...
{ GENERATE }
function span_pattern_filter_rgba_bilinear.generate(x, y: int; len: unsigned): aggclr_ptr;
var
...
{ CONSTRUCT }
constructor span_pattern_filter_rgba_2x2.Construct(alloc: span_allocator_ptr; src: rendering_buffer_ptr;
...
{ SOURCE_IMAGE_ }
procedure span_pattern_filter_rgba_2x2.source_image_(src: rendering_buffer_ptr);
begin
  inherited source_image_(src);
...
{ GENERATE }
function span_pattern_filter_rgba_2x2.generate(x, y: int; len: unsigned): aggclr_ptr;
var
  fg: array[0..3] of unsigned;
...
{ CONSTRUCT }
constructor span_pattern_filter_rgba.Construct(alloc: span_allocator_ptr; src: rendering_buffer_ptr;
  interpolator: span_interpolator_ptr; filter: image_filter_lut_ptr; WX, WY: wrap_mode_ptr;
  order: order_type);
var
  rgba: aggclr;
...
{ SOURCE_IMAGE_ }
procedure span_pattern_filter_rgba.source_image_(src: rendering_buffer_ptr);
begin
  inherited source_image_(src);
...
{ GENERATE }
function span_pattern_filter_rgba.generate(x, y: int; len: unsigned): aggclr_ptr;
var
  fg: array[0..3] of int;

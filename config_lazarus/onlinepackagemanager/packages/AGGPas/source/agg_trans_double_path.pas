...
{ BASE_LENGTH_ }
procedure trans_double_path.base_length_(v : double );
begin
 m_base_length:=v;
...
{ _BASE_LENGTH }
function trans_double_path._base_length : double;
begin
...
{ BASE_HEIGHT_ }
procedure trans_double_path.base_height_(v : double );
begin
 m_base_height:=v;
...
{ _BASE_HEIGHT }
function trans_double_path._base_height : double;
begin
...
{ PRESERVE_X_SCALE_ }
procedure trans_double_path.preserve_x_scale_(f : boolean );
begin
...
{ _PRESERVE_X_SCALE }
function trans_double_path._preserve_x_scale : boolean;
begin
...
{ MOVE_TO1 }
procedure trans_double_path.move_to1(x ,y : double );
var
 vd : vertex_dist;
...
{ LINE_TO1 }
procedure trans_double_path.line_to1(x ,y : double );
var
 vd : vertex_dist;
...
{ MOVE_TO2 }
procedure trans_double_path.move_to2(x ,y : double );
var
 vd : vertex_dist;
...
{ LINE_TO2 }
procedure trans_double_path.line_to2(x ,y : double );
var
 vd : vertex_dist;
...
{ ADD_PATHS }
procedure trans_double_path.add_paths(vs1 ,vs2 : vertex_source_ptr; path1_id : unsigned = 0; path2_id : unsigned = 0 );
var
 x ,y : double;
 cmd  : unsigned;
...
{ TOTAL_LENGTH1 }
function trans_double_path.total_length1 : double;
begin
...
{ TOTAL_LENGTH2 }
function trans_double_path.total_length2 : double;
begin
 if m_base_length >= 1e-10 then
  result:=m_base_length
 else
...
{ FINALIZE_PATH }
function trans_double_path.finalize_path(vertices : vertex_sequence_ptr ) : double;
var
 i : unsigned;
 v : vertex_dist_ptr;
...
{ TRANSFORM1 }
procedure trans_double_path.transform1(vertices : vertex_sequence_ptr; kindex ,kx : double; x ,y : double_ptr );
var

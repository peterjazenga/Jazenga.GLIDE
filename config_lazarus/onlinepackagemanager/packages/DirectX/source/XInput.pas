...
function XInputGetState(dwUserIndex: DWORD;      // [in] Index of the gamer associated with the device
  out pState: TXInputState // [out] Receives the current state
  ): DWORD; stdcall; external XINPUT_DLL;

function XInputSetState(dwUserIndex: DWORD;                 // [in] Index of the gamer associated with the device
  const pVibration: TXInputVibration  // [in, out] The vibration information to send to the controller
  ): DWORD; stdcall; external XINPUT_DLL;

function XInputGetCapabilities(dwUserIndex: DWORD;                     // [in] Index of the gamer associated with the device
...
procedure XInputEnable(enable: BOOL     // [in] Indicates whether xinput is enabled or disabled.
  ); stdcall; external XINPUT_DLL;

function XInputGetDSoundAudioDeviceGuids(dwUserIndex: DWORD;           // [in] Index of the gamer associated with the device
  out pDSoundRenderGuid: TGUID; // [out] DSound device ID for render
  out pDSoundCaptureGuid: TGUID // [out] DSound device ID for capture
  ): DWORD; stdcall; external XINPUT_DLL;

function XInputGetBatteryInformation(dwUserIndex: DWORD;          // [in]  Index of the gamer associated with the device
...
function XInputGetKeystroke(dwUserIndex: DWORD;               // [in]  Index of the gamer associated with the device

...
procedure Init_DXErr9;
 begin

    DXGetErrorString9A:= nil;
    DXGetErrorString9W:=  nil;
    DXGetErrorDescription9A:=  nil;
    DXGetErrorDescription9W:=  nil;
    DXTraceA:=  nil;
    DXTraceW:=  nil;
  ...
  begin
    DXGetErrorString9A:=TDXGetError9A(GetProcAddress(dxerr9DllInstance, 'DXGetErrorString9A'));
    DXGetErrorString9W:=  TDXGetError9W(GetProcAddress(dxerr9DllInstance, 'DXGetErrorString9W'));
    DXGetErrorDescription9A:= TDXGetError9A(GetProcAddress(dxerr9DllInstance, 'DXGetErrorDescription9A'));
    DXGetErrorDescription9W:= TDXGetError9W(GetProcAddress(dxerr9DllInstance, 'DXGetErrorDescription9W'));
    DXTraceA:=  TDXTraceA(GetProcAddress(dxerr9DllInstance, 'DXTraceA'));
    DXTraceW:=  TDXTraceW(GetProcAddress(dxerr9DllInstance, 'DXTraceW'));

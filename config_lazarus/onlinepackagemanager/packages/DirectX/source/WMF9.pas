...
type
  ...
  IWMPlayerTimestampHook = interface(IUnknown)
    ...
    function MapTimestamp(rtIn: TReferenceTime; out prtOut: TReferenceTime): HRESULT; stdcall;
  end;
  ...
  IWMCodecVideoAccelerator = interface(IUnknown)
    ...
    function NegotiateConnection(pIAMVA: IAMVideoAccelerator; pMediaType: PDMOMediaType): HRESULT;
...
type
  INSNetSourceCreator = interface(IUnknown)
    ...
    function CreateNetSource(pszStreamName: PWideChar; pMonitor: IUnknown; pData: PBYTE; pUserContext, pCallback: IUnknown;
      qwContext: int64): HRESULT; stdcall;
    ...
    function GetNetSourceProperties(pszStreamName: PWideChar; out ppPropertiesNode: IUnknown): HRESULT; stdcall;
    ...
    function GetNetSourceAdminInterface(pszStreamName: PWideChar; out pVal: olevariant): HRESULT; stdcall;
...
type
  ...
  INSSBuffer3 = interface(INSSBuffer2)
    ...
    (*** INSSBuffer3 methods ***)
    function SetProperty(guidBufferProperty: TGUID; pvBufferProperty: Pointer; dwBufferPropertySize: longword): HRESULT; stdcall;
    function GetProperty(guidBufferProperty: TGUID; {out} pvBufferProperty: Pointer; var pdwBufferPropertySize: longword): HRESULT; stdcall;
  end;
  ...
  INSSBuffer4 = interface(INSSBuffer3)
    ...
    function GetPropertyByIndex(dwBufferPropertyIndex: longword; out pguidBufferProperty: TGUID; pvBufferProperty: pointer;
...
type
  ...
  IWMSInternalAdminNetSource = interface(IUnknown)
    ...
    function Initialize(pSharedNamespace, pNamespaceNode: IUnknown;
      pNetSourceCreator: INSNetSourceCreator; fEmbeddedInServer: BOOL): HRESULT; stdcall;
    ...
    // Proxy
    function FindProxyForURL(bstrProtocol, bstrHost: WideString; out pfProxyEnabled: BOOL;
      out pbstrProxyServer: WideString; out pdwProxyPort: longword;
  ...
  IWMSInternalAdminNetSource2 = interface(IUnknown)
    ...
    // Authentication
    function SetCredentialsEx(bstrRealm: WideString; bstrUrl: WideString;
      fProxy: BOOL; bstrName: WideString;
      bstrPassword: WideString; fPersist: BOOL;
      fConfirmedGood: BOOL): HRESULT; stdcall;

    function GetCredentialsEx(bstrRealm: WideString; bstrUrl: WideString;
      fProxy: BOOL; out pdwUrlPolicy: TNetSourceURLCredpolicySettings;
      out pbstrName: WideString; out pbstrPassword: WideString;
    ...
    function FindProxyForURLEx(bstrProtocol: WideString; bstrHost: WideString;
      bstrUrl: WideString; out pfProxyEnabled: BOOL;
      out pbstrProxyServer: WideString; out pdwProxyPort: longword;
      var pdwProxyContext: longword): HRESULT; stdcall;
  ...
  IWMSInternalAdminNetSource3 = interface(IWMSInternalAdminNetSource2)
    ...
    // Proxy
    function FindProxyForURLEx2(bstrProtocol: WideString; bstrHost: WideString;
      bstrUrl: WideString; out pfProxyEnabled: BOOL;
      out pbstrProxyServer: WideString; out pdwProxyPort: longword;
    ...
    // Authentication
    function SetCredentialsEx2(bstrRealm: WideString; bstrUrl: WideString;
      fProxy: BOOL; bstrName: WideString;
      bstrPassword: WideString; fPersist: BOOL;
      fConfirmedGood: BOOL; fClearTextAuthentication: BOOL): HRESULT; stdcall;

    function GetCredentialsEx2(bstrRealm: WideString; bstrUrl: WideString;
      fProxy: BOOL; fClearTextAuthentication: BOOL;
...
type
  ...
  IWMDRMWriter = interface(IUnknown)
    ...
    function GenerateSigningKeyPair({out} pwszPrivKey: PWideChar; var pcwchPrivKeyLength: longword;
    {out} pwszPubKey: PWideChar; var pcwchPubKeyLength: longword): HRESULT;
      stdcall;
    function SetDRMAttribute(wStreamNum: word; pszName: PWideChar; Type_: TWMTAttrDataType; pValue: PBYTE; cbLength: word): HRESULT; stdcall;
  end;
  ...
  IWMPropertyVault = interface(IUnknown)
    ...
    function GetPropertyByIndex(dwIndex: longword; {out} pszName: PWideChar; var pdwNameLen: longword; out pType: TWMTAttrDataType;
    {out} pValue: PBYTE; var pdwSize: longword): HRESULT; stdcall;
  ...
  IWMSyncReader = interface(IUnknown)
    ...
    function GetNextSample(wStreamNum: word; out ppSample: INSSBuffer; out pcnsSampleTime: int64; out pcnsDuration: int64;
      out pdwFlags: longword; out pdwOutputNum: longword; out pwStreamNum: word): HRESULT; stdcall;
    ...
    function GetOutputSetting(dwOutputNum: longword; pszName: PWideChar; out pType: TWMTAttrDataType;
    {out} pValue: PBYTE; var pcbLength: word): HRESULT; stdcall;


    // Sets a named setting for a particular output

    function SetOutputSetting(dwOutputNum: longword; pszName: PWideChar; Type_: TWMTAttrDataType; {in} pValue: PBYTE;
  ...
  IWMSyncReader2 = interface(IWMSyncReader)
    ...
    function SetRangeByTimecode(wStreamNum: word; var pStart, pEnd: TWMTTimeCodeExtensionData): HRESULT; stdcall;
    ...
    function SetRangeByFrameEx(wStreamNum: word; qwFrameNumber, cFramesToRead: int64; out pcnsStartTime: int64): HRESULT; stdcall;
  ...
  IWMReaderCallback = interface(IWMStatusCallback)
    ...
    function OnSample(dwOutputNum: longword; cnsSampleTime, cnsSampleDuration: int64; dwFlags: longword;
  ...
  IWMCredentialCallback = interface(IUnknown)
    ...
    function AcquireCredentials(pwszRealm, pwszSite: PWideChar; {out} pwszUser: PWideChar; cchUser: longword;
    {out} pwszPassword: PWideChar; cchPassword: longword; hrStatus: HRESULT; out pdwFlags: longword): HRESULT;
      stdcall; // Combination of WMT_CREDENTIAL_FLAGS
  end;
  ...
  IWMHeaderInfo = interface(IUnknown)
    ...
    {out} pwszName: PWideChar; var pcchNameLen: word; out pType: TWMTAttrDataType; {out} pValue: PBYTE;
    ...
    function GetScript(wIndex: word; {out} pwszType: PWideChar; var pcchTypeLen: word; {out} pwszCommand: PWideChar;
  ...
  IWMHeaderInfo2 = interface(IWMHeaderInfo)
    ...
    {out} pwszDescription: PWideChar; out pCodecType: WMT_CODEC_INFO_TYPE; var pcbCodecInfo: word;
    {out} pbCodecInfo: PBYTE): HRESULT; stdcall;
  end;
  ...
  IWMHeaderInfo3 = interface(IWMHeaderInfo2)
    ...
    function GetAttributeIndices(wStreamNum: word; pwszName: PWideChar; pwLangIndex: PWORD; {out} pwIndices: PWORD;
      var pwCount: word): HRESULT; stdcall;

    function GetAttributeByIndexEx(wStreamNum: word; wIndex: word; {out} pwszName: PWideChar; var pwNameLen: word;
      out pType: TWMTAttrDataType; out pwLangIndex: word;
  ...
  IWMStreamConfig2 = interface(IWMStreamConfig)
    ...
    function AddDataUnitExtension(const guidExtensionSystemID: TGUID; cbExtensionDataSize: word;
      pbExtensionSystemInfo: PBYTE; cbExtensionSystemInfo: longword): HRESULT; stdcall;

    function GetDataUnitExtensionCount(out pcDataUnitExtensions: word): HRESULT; stdcall;

    function GetDataUnitExtension(wDataUnitExtensionNumber: word; out pguidExtensionSystemID: TGUID; out pcbExtensionDataSize: word;
  ...
  IWMMutualExclusion2 = interface(IWMMutualExclusion)
    ...
    function GetRecordName(wRecordNumber: word; {out} pwszRecordName: PWideChar; var pcchRecordName: word): HRESULT; stdcall;
    ...
    function GetStreamsForRecord(wRecordNumber: word; {out} pwStreamNumArray: PWORD; var pcStreams: word): HRESULT; stdcall;
  ...
  IWMWriterAdvanced = interface(IUnknown)
    ...
    function WriteStreamSample(wStreamNum: word; cnsSampleTime: int64; msSampleSendTime: longword;
      cnsSampleDuration: int64; dwFlags: longword; pSample: INSSBuffer): HResult; stdcall;
  ...
  IWMWriterAdvanced2 = interface(IWMWriterAdvanced)
    ...
    function GetInputSetting(dwInputNum: longword; pszName: PWideChar; out pType: TWMTAttrDataType;
    {out} pValue: PByte; var pcbLength: word): HResult; stdcall;
    // Sets a named setting for a particular input
    function SetInputSetting(dwInputNum: longword; pszName: PWideChar; Type_: TWMTAttrDataType; pValue: PByte;
      cbLength: word): HResult; stdcall;
  end;
  ...
  IWMWriterPreprocess = interface(IUnknown)
    ...
    function GetMaxPreprocessingPasses(dwInputNum: longword; dwFlags: longword; out pdwMaxNumPasses: longword): HResult; stdcall;
    function SetNumPreprocessingPasses(dwInputNum: longword; dwFlags: longword; dwNumPasses: longword): HResult; stdcall;
    function BeginPreprocessingPass(dwInputNum: longword; dwFlags: longword): HResult; stdcall;
    function PreprocessSample(dwInputNum: longword; cnsSampleTime: int64; dwFlags: longword; pSample: INSSBuffer): HResult; stdcall;
  ...
  IWMWriterPostView = interface(IUnknown)
    ...
    function GetPostViewFormat(wStreamNumber: word; dwFormatNumber: longword; out ppProps: IWMMediaProps): HResult;
      stdcall;
  ...
  IWMClientConnections2 = interface(IWMClientConnections)
    ...
    // Get information about a connected client
    function GetClientInfo(dwClientNum: longword; {out} pwszNetworkAddress: PWideChar; var pcchNetworkAddress: longword;
    {out} pwszPort: PWideChar; var pcchPort: longword; {out} pwszDNSName: PWideChar; var pcchDNSName: longword): HResult; stdcall;
  end;
  ...
  IWMReaderAdvanced2 = interface(IWMReaderAdvanced)
    ...
    function StartAtMarker(wMarkerIndex: word; cnsDuration: int64; fRate: single; pvContext: Pointer): HResult; stdcall;
    // Retrieves a setting for a particular output by name
    function GetOutputSetting(dwOutputNum: longword; pszName: PWideChar; out pType: TWMTAttrDataType;
    {out} pValue: PByte; var pcbLength: word): HResult; stdcall;
    // Sets a named setting for a particular output
    ...
    function OpenStream(const pStream: IStream; pCallback: IWMReaderCallback; pvContext: Pointer): HResult; stdcall;
  end;
  ...
  IWMReaderAdvanced3 = interface(IWMReaderAdvanced2)
    ...
    function StartAtPosition(wStreamNum: word; pvOffsetStart: Pointer; pvDuration: Pointer;
      dwOffsetFormat: TWMTOffsetFormat; fRate: single; pvContext: Pointer): HResult; stdcall;
  end;
  ...
  IWMReaderAllocatorEx = interface(IUnknown)
    ...
    function AllocateForStreamEx(wStreamNum: word; cbBuffer: longword; out ppBuffer: INSSBuffer;
      dwFlags: longword; cnsSampleTime: int64; cnsSampleDuration: int64;
      pvContext: Pointer): HResult; stdcall;
    function AllocateForOutputEx(dwOutputNum: longword; cbBuffer: longword; out ppBuffer: INSSBuffer;
      dwFlags: longword; cnsSampleTime: int64; cnsSampleDuration: int64;
      pvContext: Pointer): HResult; stdcall;
  end;
  ...
  IWMReaderCallbackAdvanced = interface(IUnknown)
    ...
    function OnStreamSample(wStreamNum: word; cnsSampleTime: int64; cnsSampleDuration: int64;
      dwFlags: longword; pSample: INSSBuffer; pvContext: Pointer): HResult; stdcall;
    ...
    function OnStreamSelection(wStreamCount: word; pStreamNumbers: PWord; pSelections: PWMTStreamSelection;
      pvContext: Pointer): HResult; stdcall;
  ...
  IWMIndexer = interface(IUnknown)
    ...
    function StartIndexing(pwszURL: PWideChar; pCallback: IWMStatusCallback; pvContext: Pointer): HResult; stdcall;
  ...
  IWMIndexer2 = interface(IWMIndexer)
    ...
    (*** IWMIndexer2 methods ***)
    function Configure(wStreamNum: word; nIndexerType: TWMTIndexType; pvInterval: Pointer;
      pvIndexType: Pointer): HResult; stdcall;
  end;
  ...
  IWMCodecInfo2 = interface(IWMCodecInfo)
    ...
    function GetCodecFormatDesc(const guidType: TGUID; dwCodecIndex: longword; dwFormatIndex: longword;
      out ppIStreamConfig: IWMStreamConfig;
  ...
  IWMCodecInfo3 = interface(IWMCodecInfo2)
    ...
    function GetCodecFormatProp(const guidType: TGUID; dwCodecIndex: longword; dwFormatIndex: longword;
      pszName: PWideChar; out pType: TWMTAttrDataType; {out} pValue: PByte;
    ...
    function SetCodecEnumerationSetting(const guidType: TGUID; dwCodecIndex: longword; pszName: PWideChar;
      Type_: TWMTAttrDataType;
    {in} pValue: PByte; dwSize: longword): HResult; stdcall;
    function GetCodecEnumerationSetting(const guidType: TGUID; dwCodecIndex: longword; pszName: PWideChar;
  ...
  IWMReaderAccelerator = interface(IUnknown)
    ...
    function GetCodecInterface(dwOutputNum: longword; const riid: TGUID; out ppvCodecInterface: Pointer): HResult;
      stdcall;
  ...
  IWMReaderTimecode = interface(IUnknown)
    ...
    function GetTimecodeRangeBounds(wStreamNum: word; wRangeNum: word; out pStartTimecode: longword;
      out pEndTimecode: longword): HResult; stdcall;
  end;
  ...
  IWMAddressAccess2 = interface(IWMAddressAccess)
    ...
    // Retrieve a single address access entry (by type)
    function GetAccessEntryEx(aeType: WM_AETYPE; dwEntryNum: longword; out pbstrAddress: WideString;
      out pbstrMask: WideString): HResult; stdcall;
    // Add a single address access entry
    function AddAccessEntryEx(aeType: WM_AETYPE; bstrAddress: WideString; bstrMask: WideString): HResult; stdcall;
  end;
...
type
  ...
  IAMWMBufferPassCallback = interface(IUnknown)
    ...
    function Notify(pNSSBuffer3: INSSBuffer3; pPin: IPin; prtStart, prtEnd: PReferenceTime): HRESULT; stdcall;
  end;
...
//    9000 -  ct9999 = Windows Media Real Time Collaboration
...
type
  ...
  TWMCheckURLExtension = function(pwszURL: PWideChar): HRESULT; stdcall;
  TWMCheckURLScheme = function(pwszURLScheme: PWideChar): HRESULT; stdcall;
  TWMValidateData = function(pbData: PBYTE; var pdwDataSize: longword): HRESULT; stdcall;
  TWMIsAvailableOffline = function(pwszURL, pwszLanguage: PWideChar; out pfIsAvailableOffline: BOOL): HRESULT; stdcall;
  TWMIsContentProtected = function(pwszFileName: PWideChar; out pfIsProtected: BOOL): HRESULT; stdcall;
  TWMCreateCertificate = function(out pUnkCert: IUnknown): HRESULT; stdcall;
  TWMCreateWriter = function(pUnkCert: IUnknown; out ppWriter: IWMWriter): HRESULT; stdcall;
  TWMCreateReader = function(pUnkCert: IUnknown; dwRights: longword; out ppReader: IWMReader): HRESULT; stdcall;
  TWMCreateSyncReader = function(pUnkCert: IUnknown; dwRights: longword; out ppSyncReader: IWMSyncReader): HRESULT; stdcall;
  TWMCreateEditor = function(out ppEditor: IWMMetadataEditor): HRESULT; stdcall;
  TWMCreateIndexer = function(out ppIndexer: IWMIndexer): HRESULT; stdcall;
  TWMCreateBackupRestorer = function(pCallback: IUnknown; out ppBackup: IWMLicenseBackup): HRESULT; stdcall;
  TWMCreateProfileManager = function(out ppProfileManager: IWMProfileManager): HRESULT; stdcall;
  TWMCreateWriterFileSink = function(out ppSink: IWMWriterFileSink): HRESULT; stdcall;
  TWMCreateWriterNetworkSink = function(out ppSink: IWMWriterNetworkSink): HRESULT; stdcall;
  TWMCreateWriterPushSink = function(out ppSink: IWMWriterPushSink): HRESULT; stdcall;

var
  WMVCORELib: THandle = 0;

  _WMCheckURLExtension: TWMCheckURLExtension;
  _WMCheckURLScheme: TWMCheckURLScheme;
  _WMValidateData: TWMValidateData;
  _WMIsAvailableOffline: TWMIsAvailableOffline;
  _WMIsContentProtected: TWMIsContentProtected;
  _WMCreateCertificate: TWMCreateCertificate;
  _WMCreateWriter: TWMCreateWriter;
  _WMCreateReader: TWMCreateReader;
  _WMCreateSyncReader: TWMCreateSyncReader;
  _WMCreateEditor: TWMCreateEditor;
  _WMCreateIndexer: TWMCreateIndexer;
  _WMCreateBackupRestorer: TWMCreateBackupRestorer;
  _WMCreateProfileManager: TWMCreateProfileManager;
  _WMCreateWriterFileSink: TWMCreateWriterFileSink;
  _WMCreateWriterNetworkSink: TWMCreateWriterNetworkSink;
  _WMCreateWriterPushSink: TWMCreateWriterPushSink;
...
begin
  ...
  begin
    ...
    if WMVCORELoaded then
    begin
      _WMCheckURLExtension := TWMCheckURLExtension(GetProcAddress(WMVCORELib, 'WMCheckURLExtension'));
      _WMCheckURLScheme := TWMCheckURLScheme(GetProcAddress(WMVCORELib, 'WMCheckURLScheme'));
      _WMValidateData := TWMValidateData(GetProcAddress(WMVCORELib, 'WMValidateData'));
      _WMIsAvailableOffline := TWMIsAvailableOffline(GetProcAddress(WMVCORELib, 'WMIsAvailableOffline'));
      _WMIsContentProtected := TWMIsContentProtected(GetProcAddress(WMVCORELib, 'WMIsContentProtected'));
      _WMCreateCertificate := TWMCreateCertificate(GetProcAddress(WMVCORELib, 'WMCreateCertificate'));
      _WMCreateWriter := TWMCreateWriter(GetProcAddress(WMVCORELib, 'WMCreateWriter'));
      _WMCreateReader := TWMCreateReader(GetProcAddress(WMVCORELib, 'WMCreateReader'));
      _WMCreateSyncReader := TWMCreateSyncReader(GetProcAddress(WMVCORELib, 'WMCreateSyncReader'));
      _WMCreateEditor := TWMCreateEditor(GetProcAddress(WMVCORELib, 'WMCreateEditor'));
      _WMCreateIndexer := TWMCreateIndexer(GetProcAddress(WMVCORELib, 'WMCreateIndexer'));
      _WMCreateBackupRestorer := TWMCreateBackupRestorer(GetProcAddress(WMVCORELib, 'WMCreateBackupRestorer'));
      _WMCreateProfileManager := TWMCreateProfileManager(GetProcAddress(WMVCORELib, 'WMCreateProfileManager'));
      _WMCreateWriterFileSink := TWMCreateWriterFileSink(GetProcAddress(WMVCORELib, 'WMCreateWriterFileSink'));
      _WMCreateWriterNetworkSink := TWMCreateWriterNetworkSink(GetProcAddress(WMVCORELib, 'WMCreateWriterNetworkSink'));
      _WMCreateWriterPushSink := TWMCreateWriterPushSink(GetProcAddress(WMVCORELib, 'WMCreateWriterPushSink'));

      Result := Assigned(_WMCheckURLExtension) and Assigned(_WMCheckURLScheme) and Assigned(_WMValidateData) and
        Assigned(_WMIsAvailableOffline) and Assigned(_WMIsContentProtected) and Assigned(_WMCreateCertificate) and
        Assigned(_WMCreateWriter) and Assigned(_WMCreateReader) and Assigned(_WMCreateSyncReader) and
        Assigned(_WMCreateEditor) and Assigned(_WMCreateIndexer) and Assigned(_WMCreateBackupRestorer) and
        Assigned(_WMCreateProfileManager) and Assigned(_WMCreateWriterFileSink) and Assigned(_WMCreateWriterNetworkSink) and
        Assigned(_WMCreateWriterPushSink);
      if not Result then
        UnLoadWMVCORE;
    end;
  end;

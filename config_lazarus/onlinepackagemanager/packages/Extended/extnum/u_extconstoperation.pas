...
procedure TExtCOperation.p_setOperated1(const AOperated: TCustomEdit);
begin
  if  (AOperated <> Self)
...
begin
  ...
  or ( csloading in ComponentState )
   Then Exit;
  Value := fe_Calculate ( fvar_getComponentProperty(FOperated1,CST_PROPERTY_VALUE),  FOperated2, FOperation );
  if not ab_all

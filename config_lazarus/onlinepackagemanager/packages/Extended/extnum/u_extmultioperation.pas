...
const
     gVer_TExtMOperation : T_Version = ( Component : 'Composant TExtMOperation' ;
                                         ...
                                         BugsStory : '1.0.1.0 : TCustomEdit recognize really.' +#13#10
                                                   + '1.0.0.0 : TCustomEdit recognize but blank at beginning.' +#13#10
...
type
  ...
  published
    ...
    property Operated3  : TCustomEdit read FOperated3 write p_setOperated3;
...
procedure TExtMOperation.p_setOperated3(const AOperated: TCustomEdit);
begin
  if  (AOperated <> Self)
